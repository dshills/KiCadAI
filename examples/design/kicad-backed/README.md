...
| `usb_c_i2c_sensor_3v3_protected` | `expected_fail` | Tracks the medium-complexity AI-generated target fixture: `usb_c_power` input, protected VBUS path, 5 V to 3.3 V regulator rail, I2C sensor, pull-ups, decoupling, and header. Current blocker is KiCad DRC/connectivity evidence from route-tree VCC/GND geometry crossing local USB/regulator copper. |
...
promote to `candidate`; remaining optional KiCad-backed fixtures are still
