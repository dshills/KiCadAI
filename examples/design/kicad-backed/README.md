...
| `connector_led_kicad_smoke` | `expected_fail` | Tracks connector-to-LED multi-block composition after local route endpoint binding; current blocker is full inter-block routing and DRC-clean promotion. |
