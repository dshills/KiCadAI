...
Next: integrate the second reference into the existing shared configuration/generation/validation command, preserving first-family native behavior; complete family-specific electrical checks, manufacturing exports, deterministic replay and compact final acceptance. Native reference checks alone do not complete the goal.
