...
const phase=dirname(fileURLToPath(import.meta.url)),root=process.argv[2]||'/tmp/kicadai-ownership-locality-offline-v2-final',prior='/tmp/kicadai-functional-readability-offline-v1-final';
...
const result={schema:'kicadai.functional-locality-descriptive.v1',root,prior,cases,method:'Euclidean symbol-origin distance in millimeters from sealed generation transactions. Group anchors require exactly one active component. Support-parent values use recorded explicit ownership. The preregistered locality target is lower mean and maximum without individual regression. These are not PCB distances or sufficient readability acceptance.',readability_passes:0,practical_benchmark_passes_added:0};
