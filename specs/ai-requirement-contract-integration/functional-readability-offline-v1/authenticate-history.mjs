...
const previous=[];
for(const [name,commit] of [['pcb-seed-rotated-fields','9ac563194a4a3b89d52d54b8ee38ce04a157ff58'],['native-readability-replay','446e19c9b934ad8026b4e9ec2996b47d9ef413f9']]){
...
const result={schema:'kicadai.functional-readability-history.v1',verified_utc:new Date().toISOString(),previous,preceding,campaign,provider_calls:0};
