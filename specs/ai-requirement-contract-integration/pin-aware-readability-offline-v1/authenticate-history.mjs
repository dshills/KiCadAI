...
const previous=[];
for(const [name,commit] of [['ownership-locality','f8b29a9904dd02c38583cb4c15d72f55b5ee6b75'],['functional-readability','c2ec8c88da11f8cf4aac498775e216ae2baaa34d'],['pcb-seed-rotated-fields','9ac563194a4a3b89d52d54b8ee38ce04a157ff58'],['native-readability-replay','446e19c9b934ad8026b4e9ec2996b47d9ef413f9']]){
...
const result={schema:'kicadai.pin-aware-readability-history.v1',verified_utc:new Date().toISOString(),previous,preceding,campaign,provider_calls:0};
