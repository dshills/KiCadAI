...
const phase=dirname(fileURLToPath(import.meta.url)),root=process.argv[2]||'/tmp/kicadai-pin-aware-readability-offline-v1-final',prior='/tmp/kicadai-ownership-locality-offline-v2-final';
