...
const phase=dirname(fileURLToPath(import.meta.url)),root='/tmp/kicadai-joint-annotation-placement-offline-v1-final';
...
const result={schema:'kicadai.joint-placement-visual-review.v1',root,reviewer:'implementing agent; local review only',files,full_schematics:2,functional_crops:6,copper_layer_images:6,complete_readability_examples:0,planned_examples:2,technical_results:'verification.json',pin_side_and_panel_evidence:'pin-aware-audit.json',findings:'VISUAL_REVIEW.md',limitations:['Controller detail crop clips upper panel rows; full-sheet view and independent emitted-text audit used together.','No independent external review, fabrication, signal-integrity or assembly sign-off.'],provider_calls:0,benchmark_passes_added:0};
