...
const names=['dev1','dev2','dev3','final'].map(n=>'kicadai-joint-annotation-placement-offline-v1-'+n).filter(n=>existsSync(join('/tmp',n)));
...
const archive=join(repo,'.cache/joint-annotation-placement-offline-v1-all-runs.tar.gz');assert(!existsSync(archive));
