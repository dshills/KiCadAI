...
const result={schema:'kicadai.local-wiring-readability-history.v1',verified_utc:new Date().toISOString(),previous,preceding,campaign,provider_calls:0};
