...
const phase=dirname(fileURLToPath(import.meta.url)),root=process.argv[2]||'/tmp/kicadai-local-wiring-readability-offline-v1-final',prior='/tmp/kicadai-joint-annotation-placement-offline-v1-final';
