...
// Pins the complete retained inventory from the original frozen run.
const publicationManifestSHA256 = "4d3c8dc8c0f07f068631f0c3427e095226104a5614cb2ee1006d9f3c56117182"
...
func TestPublishedV23Inventory(t *testing.T) {
	...
	for i, record := range report.Cases {
		...
		for replay := 1; replay <= 2; replay++ {
			...
			readJSON(t, filepath.Join(publication, prefix, "METRICS.json"), &metrics)
