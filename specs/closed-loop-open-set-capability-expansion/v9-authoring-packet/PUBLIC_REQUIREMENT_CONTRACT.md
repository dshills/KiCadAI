# Public Open-Topology Requirement Contract for V9 Authoring
...
namespace. Every number is a finite JSON number. Manifest-only `v9_case_*` and
`v9_source_*` strings are prohibited throughout the requirement.
