# Public Open-Topology Requirement Contract for V5 Authoring
...
implementation clue in project text. Manifest-only `v5_case_*` and
`v5_source_*` identities are prohibited everywhere in a requirement file.
...
Allowed metrics for V5 authoring:
