...
func TestV21ContractAndEvaluatorManifests(t *testing.T) {
	...
	if freeze.Schema != "kicadai.closed-loop-open-set-evaluator-freeze.v21" || freeze.Version != 21 || freeze.FreezeParentCommit != "6aa63c6267e8d1128abeef7082423d23a85e0735" {
