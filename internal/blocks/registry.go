...
func NewBuiltinRegistryChecked() (BuiltinRegistry, []reports.Issue) {
	...
	registry.instantiators = map[string]BlockInstantiator{
		...
		"class_ab_speaker_power_stage": instantiateClassABSpeakerPowerStage,
		...
		"speaker_opamp_driver":         instantiateSpeakerOpAmpDriver,
		"speaker_output_protection":    instantiateSpeakerOutputProtection,
