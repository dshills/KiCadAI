...
func voltageRegulatorDefinition() BlockDefinition {
	parameters := []BlockParameter{
		...
		{Name: "regulator_footprint", Type: ParameterFootprintID, Default: defaultRegulatorFootprint, Description: "KiCad footprint ID for the regulator."},
	...
	return BlockDefinition{
		...
		RequiredLibraries: []LibraryRequirement{
			...
			{Kind: "footprint", ID: defaultRegulatorFootprint, Required: true, Description: "Default regulator footprint."},
		...
		Components: voltageRegulatorComponents(voltageRegulatorComponentDefaults{
			...
			RegulatorPins:      ams1117SOT223Pins(),
