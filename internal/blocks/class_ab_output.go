...
func classABOutputStagePCBRealization() *PCBRealization {
	...
	return &PCBRealization{
		...
		LocalRoutes: []PCBLocalRoute{
			...
			{ID: "diode_driver_entry", NetTemplate: "driver_out", From: RouteEndpoint{Port: "DRIVER_OUT"}, To: RouteEndpoint{ComponentRole: "bias_upper", Pin: "2"}, Waypoints: []RelativePoint{{XMM: 8, YMM: 0}, {XMM: 8, YMM: -3}}, Layer: "B.Cu", WidthMM: 0.25, Required: true, When: diodeString},
			...
			{ID: "multiplier_driver_entry", NetTemplate: "driver_out", From: RouteEndpoint{Port: "DRIVER_OUT"}, To: RouteEndpoint{ComponentRole: "bias_multiplier", Pin: "1"}, Layer: "F.Cu", WidthMM: 0.25, Required: true, When: vbeMultiplier},
