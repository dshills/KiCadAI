...
func voltageRegulatorPCBRealization() *PCBRealization {
	...
	ap2112VOUTBypass := []PCBRouteGeometryVariant{{Waypoints: []RelativePoint{{XMM: 5.4, YMM: -2}, {XMM: 3, YMM: -2}, {XMM: 3, YMM: -0.95}}, When: ap2112}}
	return &PCBRealization{
		Version:           "0.1.0",
		VerificationLevel: PCBVerificationPlacementVerified,
		Components: []PCBComponentRealization{
		...
		LocalRoutes: []PCBLocalRoute{
			...
			{ID: "vout_bypass", NetTemplate: "vout", From: RouteEndpoint{ComponentRole: "output_capacitor", Pin: "1"}, To: RouteEndpoint{ComponentRole: "regulator", Pin: "2"}, GeometryVariants: ap2112VOUTBypass, Layer: "F.Cu", WidthMM: 0.5, Required: true},
