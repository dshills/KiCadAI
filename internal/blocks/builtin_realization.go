...
func voltageRegulatorPCBRealization() *PCBRealization {
	return &PCBRealization{
		...
		LocalRoutes: []PCBLocalRoute{
			{ID: "vin_entry", NetTemplate: "vin", From: RouteEndpoint{Port: "VIN"}, To: RouteEndpoint{ComponentRole: "input_capacitor", Pin: "1"}, Waypoints: []RelativePoint{{XMM: -11.1, YMM: -4}, {XMM: -11.1, YMM: 13}}, Layer: "F.Cu", WidthMM: 0.5, Required: true},
			{ID: "vout_entry", NetTemplate: "vout", From: RouteEndpoint{Port: "VOUT"}, To: RouteEndpoint{ComponentRole: "output_capacitor", Pin: "1"}, Waypoints: []RelativePoint{{XMM: 5.4, YMM: 22.5}, {XMM: -5.6, YMM: 22.5}}, Layer: "F.Cu", WidthMM: 0.5, Required: true},
