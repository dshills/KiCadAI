...
const (
	...
	regulatorVINEntryCorridorXMM = -11.2
)
...
func i2cSensorPCBRealization() *PCBRealization {
	...
	bmp280SDAEscape := []PCBWaypointVariant{{Waypoints: []RelativePoint{{XMM: 20.6, YMM: 9.5}, {XMM: 14, YMM: 9.5}, {XMM: 30, YMM: 10}}, When: bmp280}}
	bmp280SCLEscape := []PCBWaypointVariant{{Waypoints: []RelativePoint{{XMM: 20.6, YMM: 13}, {XMM: 29.8, YMM: 14.2}}, When: bmp280}}
	bmp280EndpointDogbone := []PCBEndpointVariant{{ToEndpointDogbone: true, When: bmp280}}
	bmp280DisableRoute := []PCBRouteGeometryVariant{{DisableRoute: true, When: bmp280}}
	...
	return &PCBRealization{
		...
		LocalRoutes: []PCBLocalRoute{
			...
			{ID: "scl_pullup_vcc", NetTemplate: "vcc", From: RouteEndpoint{ComponentRole: "scl_pullup", Pin: "1"}, To: RouteEndpoint{ComponentRole: "sensor", Pin: genericI2CSensorPins.VCC}, Waypoints: []RelativePoint{{XMM: 15, YMM: 20}, {XMM: 15, YMM: 13.095}, {XMM: 25.05, YMM: 13.095}}, WaypointVariants: bmp280VCCTrunk, GeometryVariants: bmp280DisableRoute, Layer: "F.Cu", WidthMM: 0.25, Required: true, When: pullupsEnabled},
			{ID: "bmp280_scl_pullup_supply", NetTemplate: "vcc", From: RouteEndpoint{ComponentRole: "scl_pullup", Pin: "1"}, To: RouteEndpoint{ComponentRole: "decoupling_capacitor", Pin: "1"}, Layer: "B.Cu", WidthMM: 0.25, Required: true, When: bmp280, Description: "Bottom-layer SCL pull-up supply crosses the F.Cu ground corridor into the decoupling VCC node."},
			...
			{ID: "bmp280_vddio_tie", NetTemplate: "vcc", From: RouteEndpoint{ComponentRole: "sensor", Pin: "6"}, To: RouteEndpoint{ComponentRole: "sensor", Pin: "8"}, Waypoints: []RelativePoint{{XMM: 29, YMM: 18.5}, {XMM: 23.5, YMM: 18.5}, {XMM: 23.5, YMM: 15.2}}, FromEndpointDogbone: true, ToEndpointDogbone: true, Layer: "B.Cu", WidthMM: 0.2, Required: true, When: bmp280, Description: "Escape VDDIO below the bus, carry VCC left on B.Cu, and rise outside the SDA/SCL fanout before the VDD dogbone."},
			{ID: "bmp280_csb_tie", NetTemplate: "vcc", From: RouteEndpoint{ComponentRole: "sensor", Pin: "2"}, To: RouteEndpoint{ComponentRole: "decoupling_capacitor", Pin: "1"}, Waypoints: []RelativePoint{{XMM: 27.675, YMM: 12.5}, {XMM: 19.4, YMM: 12.5}}, Layer: "F.Cu", WidthMM: 0.2, Required: true, When: bmp280},
		},
		Constraints: []PCBConstraint{
...
func amplifierInputBufferPCBRealization() *PCBRealization {
	return &PCBRealization{
		...
		LocalRoutes: []PCBLocalRoute{
			{ID: "input_to_stopper", NetTemplate: "in", From: RouteEndpoint{Port: "IN"}, To: RouteEndpoint{ComponentRole: "input_stopper", Pin: "1"}, Layer: "F.Cu", WidthMM: 0.25, Required: true, DisableEntryAnchorVia: true},
			...
			{ID: "coupled_output", NetTemplate: "out", From: RouteEndpoint{ComponentRole: "input_coupling", Pin: "2"}, To: RouteEndpoint{Port: "OUT"}, Layer: "F.Cu", WidthMM: 0.25, Required: true, DisableEntryAnchorVia: true},
...
func opAmpGainStagePCBRealization() *PCBRealization {
	return &PCBRealization{
		...
		Components: []PCBComponentRealization{
			...
			{ComponentRole: "gain_to_ground", FootprintParam: "feedback_footprint", Placement: RelativePlacement{XMM: 4, YMM: 4, Layer: "F.Cu"}},
		...
		EntryAnchors: []PCBEntryAnchor{
			...
			{ID: "vcc", Port: "VCC", NetTemplate: "vcc", Placement: RelativePlacement{XMM: 1.1375, YMM: -0.95, Layer: "F.Cu"}, Description: "Positive supply interface point at the supported LMV321 VCC pad."},
			{ID: "gnd", Port: "GND", NetTemplate: "gnd", Placement: RelativePlacement{XMM: -1.1375, YMM: 0, Layer: "F.Cu"}, Description: "Reference or negative supply interface point at the supported LMV321 VEE pad."},
		},
		...
		LocalRoutes: []PCBLocalRoute{
			{ID: "dc_input", NetTemplate: "in", From: RouteEndpoint{Port: "IN"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.INP}, Layer: "F.Cu", WidthMM: 0.25, Required: true, DisableEntryAnchorVia: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "dc"}}},
			{ID: "ac_input_coupling", NetTemplate: "in", From: RouteEndpoint{Port: "IN"}, To: RouteEndpoint{ComponentRole: "input_coupling", Pin: "1"}, Layer: "F.Cu", WidthMM: 0.25, Required: true, DisableEntryAnchorVia: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "ac"}}},
			{ID: "ac_input_bias", NetTemplate: "bias", From: RouteEndpoint{ComponentRole: "input_coupling", Pin: "2"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.INP}, Waypoints: []RelativePoint{{XMM: -10, YMM: 1.8}, {XMM: -2, YMM: 1.8}}, Layer: "B.Cu", WidthMM: 0.25, Required: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "ac"}}},
			{ID: "bias_top", NetTemplate: "bias", From: RouteEndpoint{ComponentRole: "bias_top", Pin: "2"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.INP}, Waypoints: []RelativePoint{{XMM: -9, YMM: -5}, {XMM: -9, YMM: 1.8}, {XMM: -2, YMM: 1.8}}, Layer: "B.Cu", WidthMM: 0.25, Required: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "ac"}}},
			{ID: "bias_bottom", NetTemplate: "bias", From: RouteEndpoint{ComponentRole: "bias_bottom", Pin: "1"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.INP}, Waypoints: []RelativePoint{{XMM: -9, YMM: 5}, {XMM: -9, YMM: 1.8}, {XMM: -2, YMM: 1.8}}, Layer: "B.Cu", WidthMM: 0.25, Required: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "ac"}}},
			{ID: "bias_vcc", NetTemplate: "vcc", From: RouteEndpoint{ComponentRole: "bias_top", Pin: "1"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.VCC}, Waypoints: []RelativePoint{{XMM: -10, YMM: -7}, {XMM: 3, YMM: -7}, {XMM: 3, YMM: -0.95}}, Layer: "F.Cu", WidthMM: 0.25, Required: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "ac"}}},
			{ID: "bias_gnd", NetTemplate: "gnd", From: RouteEndpoint{ComponentRole: "bias_bottom", Pin: "2"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.VEE}, Waypoints: []RelativePoint{{XMM: -8, YMM: 9}, {XMM: -4, YMM: 9}, {XMM: -4, YMM: 0}}, Layer: "F.Cu", WidthMM: 0.25, Required: true, When: RealizationWhen{Params: map[string]any{"input_coupling": "ac"}}},
			{ID: "opamp_vcc_entry", NetTemplate: "vcc", From: RouteEndpoint{Port: "VCC"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.VCC}, Layer: "F.Cu", WidthMM: 0.3, Required: true, DisableEntryAnchorVia: true},
			{ID: "opamp_gnd_entry", NetTemplate: "gnd", From: RouteEndpoint{Port: "GND"}, To: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.VEE}, Layer: "F.Cu", WidthMM: 0.3, Required: true, DisableEntryAnchorVia: true},
			...
			{ID: "feedback_output_drive", NetTemplate: "out_drive", From: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.OUT}, To: RouteEndpoint{ComponentRole: "feedback", Pin: "1"}, Waypoints: []RelativePoint{{XMM: -6, YMM: -0.95}, {XMM: -6, YMM: -5.5}, {XMM: -4.6, YMM: -5.5}}, Layer: "B.Cu", WidthMM: 0.25, Required: true, When: RealizationWhen{Params: map[string]any{"include_output_resistor": true}}},
			{ID: "opamp_output_direct", NetTemplate: "out", From: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.OUT}, To: RouteEndpoint{Port: "OUT"}, Layer: "F.Cu", WidthMM: 0.3, Required: true, DisableEntryAnchorVia: true, When: RealizationWhen{Params: map[string]any{"include_output_resistor": false}}},
			{ID: "output_resistor_input", NetTemplate: "out_drive", From: RouteEndpoint{ComponentRole: "opamp", Pin: lmv321Pins.OUT}, To: RouteEndpoint{ComponentRole: "output_resistor", Pin: "1"}, Waypoints: []RelativePoint{{XMM: -6, YMM: -0.95}, {XMM: -6, YMM: -5.5}, {XMM: 7.4, YMM: -5.5}}, Layer: "B.Cu", WidthMM: 0.3, Required: true, When: RealizationWhen{Params: map[string]any{"include_output_resistor": true}}},
		...
		Constraints: []PCBConstraint{
			{ID: "opamp_feedback_proximity", Kind: "proximity", Category: PCBConstraintFeedbackSense, NetTemplate: "feedback", AppliesTo: []string{"opamp", "feedback", "gain_to_ground"}, MaxLengthMM: 6, Description: "Feedback network should remain close to the op-amp inverting input."},
			{ID: "opamp_supply_decoupling_proximity", Kind: "proximity", Category: PCBConstraintDecouplingProximity, NetTemplate: "vcc", AppliesTo: []string{"opamp", "decoupling_capacitor"}, MaxLengthMM: 5, Description: "Supply decoupling capacitor should remain close to the op-amp supply pins."},
			{ID: "opamp_input_output_separation", Kind: "analog_separation", Category: PCBConstraintAnalogInputSeparation, AppliesTo: []string{"opamp", "feedback", "output_resistor"}, ClearanceMM: 3, Description: "Keep input and feedback nodes separated from output copper where placement permits."},
...
func usbCPowerPCBRealization() *PCBRealization {
	...
	return &PCBRealization{
		...
		Keepouts: []PCBKeepout{
			{ID: "usb_c_edge_keepout", PlacementGroupID: "usb_c_power_entry", Layer: "F.Cu", Bounds: RelativeBounds{MinXMM: -5, MinYMM: -8, MaxXMM: 3, MaxYMM: 8}, AppliesTo: []string{"usb_c_receptacle", "cc1_rd"}, BlocksRoute: boolPtr(false), Description: "Reserve board-edge clearance around the USB-C receptacle while retaining its intentionally adjacent CC1 pull-down."},
		...
		LocalRoutes: []PCBLocalRoute{
			...
			{ID: "cc2_pull_down", NetTemplate: "cc2", From: RouteEndpoint{ComponentRole: "usb_c_receptacle", Pin: usbCPowerPins.CC2}, To: RouteEndpoint{ComponentRole: "cc2_rd", Pin: "1"}, Waypoints: []RelativePoint{{XMM: 0.5, YMM: -0.6}, {XMM: 5.0, YMM: -0.6}}, EndpointVariants: []PCBEndpointVariant{{FromEndpointDogbone: true, ToEndpointDogbone: true, When: minimalPowerOnly}}, GeometryVariants: []PCBRouteGeometryVariant{{Waypoints: []RelativePoint{{XMM: 0.5, YMM: -4.5}, {XMM: 6, YMM: -4.5}}, Layer: "B.Cu", When: minimalPowerOnly}}, Layer: "F.Cu", WidthMM: 0.25, Required: true},
