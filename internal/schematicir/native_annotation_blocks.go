...
func nativeSchematicBlocks(document Document) []schematiclayout.NativeAnnotationBlock {
	if (document.Layout.FunctionalProfile != schematiclayout.FunctionalOwnershipV3 && document.Layout.FunctionalProfile != schematiclayout.FunctionalOwnershipV4 && document.Layout.FunctionalProfile != schematiclayout.FunctionalOwnershipV5 && document.Layout.FunctionalProfile != schematiclayout.FunctionalOwnershipV6) || document.Layout.NativeProfile != schematiclayout.NativeAnnotationV2 {
		return nil
	}
