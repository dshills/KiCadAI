...
type AuthorshipAttestations struct {
	...
	NoObligationAnchorGapExposureOrCausalPathAuthorship     bool `json:"no_obligation_anchor_gap_exposure_or_causal_path_authorship"`
...
func (a AuthorshipAttestations) allTrue() bool {
	return a.PacketOnlyInput && a.ContractBoundBeforeAuthoring && a.NoRepositoryOrPriorCorpusAccess &&
		...
		a.NoImplementationOrExpectedOutcomePrescription && a.NoObligationAnchorGapExposureOrCausalPathAuthorship &&
