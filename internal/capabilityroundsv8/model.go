// Package capabilityroundsv8 implements the frozen V8 public selection and
...
var (
	ErrInvalidInput      = errors.New("invalid V8 capability-round input")
	ErrCandidateOverflow = errors.New("V8 candidate closure exceeds its frozen ceiling")
	ErrNoEligibleBundle  = errors.New("no eligible V8 capability bundle")
	ErrRoundGate         = errors.New("V8 public round gate failed")
)
...
func FrozenPolicy() Policy {
	return Policy{
		ExpectedDiscoveryCases: 18, MaximumCandidates: 262144, MaximumRounds: 3,
		MaximumTotalAtoms: 9, MaximumTotalMembers: 27, MaximumRoundAtoms: 3,
...
func validatePolicy(policy Policy) error {
	if !reflect.DeepEqual(policy, FrozenPolicy()) {
		return fmt.Errorf("%w: policy differs from the frozen V8 contract", ErrInvalidInput)
	}
	return nil
}
