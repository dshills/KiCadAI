...
const (
	ManifestSchemaV7  = "kicadai.closed-loop-open-set-held-out-baseline-seal.v7"
	ManifestVersionV7 = 7
	AlgorithmV7       = "AES-256-GCM/v7-magic/random-nonce-prefixed/length-delimited-aad"
	// nonceBytesV7 is part of the frozen V7 wire format, not a provider
	// default. A future nonce format requires a new protocol version.
	nonceBytesV7 = 12
)

// V7Binding is the complete public commitment boundary for a V7 baseline.
// It is deliberately separate from Binding so extending V7 cannot change the
// frozen V5 authenticated-data contract.
type V7Binding struct {
...
func (binding V7Binding) fields() []bindingField {
	return []bindingField{
...
type V7Manifest struct {
	Schema           string    `json:"schema"`
	Version          int       `json:"version"`
	Algorithm        string    `json:"algorithm"`
	Binding          V7Binding `json:"binding"`
