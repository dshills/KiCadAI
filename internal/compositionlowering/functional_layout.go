...
func applyFunctionalLayout(request *designworkflow.Request, candidate architecturesearch.CandidateResult, synthesis circuitgraph.SynthesisReport, profile string) error {
	if (profile != schematiclayout.FunctionalOwnershipV1 && profile != schematiclayout.FunctionalOwnershipV2 && profile != schematiclayout.FunctionalOwnershipV3) || request.ExplicitCircuit == nil {
