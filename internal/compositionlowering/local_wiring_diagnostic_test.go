...
func TestFunctionalLocalWiringRecordedLayoutDiagnostic(t *testing.T) {
	...
	request.ExplicitCircuit.Schematic.Layout.FunctionalProfile = schematiclayout.FunctionalOwnershipV5
