...
func BuildProviderContext(prompt string, capabilities json.RawMessage) (string, error) {
	...
	context := ProviderContext{
		...
		Policy: []string{
			...
			"participant_port observations and generated port:<id> supply sources currently require exactly one reference domain; multi-reference routing remains a capability gap, even if a ground name resembles the participant supply name",
