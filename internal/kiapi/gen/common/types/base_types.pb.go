...
type GraphicEllipseAttributes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Center        *Vector2               `protobuf:"bytes,1,opt,name=center,proto3" json:"center,omitempty"`
	MajorRadius   *Distance              `protobuf:"bytes,2,opt,name=major_radius,json=majorRadius,proto3" json:"major_radius,omitempty"`
	MinorRadius   *Distance              `protobuf:"bytes,3,opt,name=minor_radius,json=minorRadius,proto3" json:"minor_radius,omitempty"`
	Rotation      *Angle                 `protobuf:"bytes,4,opt,name=rotation,proto3" json:"rotation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GraphicEllipseAttributes) Reset() {
	*x = GraphicEllipseAttributes{}
	mi := &file_common_types_base_types_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GraphicEllipseAttributes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GraphicEllipseAttributes) ProtoMessage() {}

func (x *GraphicEllipseAttributes) ProtoReflect() protoreflect.Message {
	mi := &file_common_types_base_types_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GraphicEllipseAttributes.ProtoReflect.Descriptor instead.
func (*GraphicEllipseAttributes) Descriptor() ([]byte, []int) {
	return file_common_types_base_types_proto_rawDescGZIP(), []int{33}
}

func (x *GraphicEllipseAttributes) GetCenter() *Vector2 {
	if x != nil {
		return x.Center
	}
	return nil
...
func (x *GraphicEllipseAttributes) GetMajorRadius() *Distance {
	if x != nil {
...
func (x *GraphicEllipseAttributes) GetMinorRadius() *Distance {
	if x != nil {
...
func (x *GraphicEllipseAttributes) GetRotation() *Angle {
	if x != nil {
		return x.Rotation
	}
	return nil
...
type GraphicEllipseArcAttributes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Center        *Vector2               `protobuf:"bytes,1,opt,name=center,proto3" json:"center,omitempty"`
	MajorRadius   *Distance              `protobuf:"bytes,2,opt,name=major_radius,json=majorRadius,proto3" json:"major_radius,omitempty"`
	MinorRadius   *Distance              `protobuf:"bytes,3,opt,name=minor_radius,json=minorRadius,proto3" json:"minor_radius,omitempty"`
	Rotation      *Angle                 `protobuf:"bytes,4,opt,name=rotation,proto3" json:"rotation,omitempty"`
	StartAngle    *Angle                 `protobuf:"bytes,5,opt,name=start_angle,json=startAngle,proto3" json:"start_angle,omitempty"`
	EndAngle      *Angle                 `protobuf:"bytes,6,opt,name=end_angle,json=endAngle,proto3" json:"end_angle,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GraphicEllipseArcAttributes) Reset() {
	*x = GraphicEllipseArcAttributes{}
	mi := &file_common_types_base_types_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GraphicEllipseArcAttributes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GraphicEllipseArcAttributes) ProtoMessage() {}

func (x *GraphicEllipseArcAttributes) ProtoReflect() protoreflect.Message {
	mi := &file_common_types_base_types_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GraphicEllipseArcAttributes.ProtoReflect.Descriptor instead.
func (*GraphicEllipseArcAttributes) Descriptor() ([]byte, []int) {
	return file_common_types_base_types_proto_rawDescGZIP(), []int{34}
}

func (x *GraphicEllipseArcAttributes) GetCenter() *Vector2 {
	if x != nil {
		return x.Center
	}
	return nil
...
func (x *GraphicEllipseArcAttributes) GetMajorRadius() *Distance {
	if x != nil {
		return x.MajorRadius
	}
	return nil
...
func (x *GraphicEllipseArcAttributes) GetMinorRadius() *Distance {
	if x != nil {
		return x.MinorRadius
	}
	return nil
...
func (x *GraphicEllipseArcAttributes) GetRotation() *Angle {
	if x != nil {
		return x.Rotation
	}
	return nil
...
func (x *GraphicEllipseArcAttributes) GetStartAngle() *Angle {
	if x != nil {
		return x.StartAngle
	}
	return nil
...
func (x *GraphicEllipseArcAttributes) GetEndAngle() *Angle {
	if x != nil {
		return x.EndAngle
	}
	return nil
...
type GraphicShape struct {
	...
	//	*GraphicShape_Bezier
	//	*GraphicShape_Ellipse
	//	*GraphicShape_EllipseArc
...
func (x *GraphicShape) GetEllipse() *GraphicEllipseAttributes {
	if x != nil {
		if x, ok := x.Geometry.(*GraphicShape_Ellipse); ok {
			return x.Ellipse
		}
	}
	return nil
...
func (x *GraphicShape) GetEllipseArc() *GraphicEllipseArcAttributes {
	if x != nil {
		if x, ok := x.Geometry.(*GraphicShape_EllipseArc); ok {
			return x.EllipseArc
		}
	}
	return nil
...
type GraphicShape_Ellipse struct {
	Ellipse *GraphicEllipseAttributes `protobuf:"bytes,10,opt,name=ellipse,proto3,oneof"`
}

type GraphicShape_EllipseArc struct {
	EllipseArc *GraphicEllipseArcAttributes `protobuf:"bytes,11,opt,name=ellipse_arc,json=ellipseArc,proto3,oneof"`
}
...
func (*GraphicShape_Ellipse) isGraphicShape_Geometry() {}

func (*GraphicShape_EllipseArc) isGraphicShape_Geometry() {}
...
func (x *MinOptMax) Reset() {
	*x = MinOptMax{}
	mi := &file_common_types_base_types_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MinOptMax) Descriptor() ([]byte, []int) {
	return file_common_types_base_types_proto_rawDescGZIP(), []int{40}
}
...
func (x *PageSettings) Reset() {
	*x = PageSettings{}
	mi := &file_common_types_base_types_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PageSettings) Descriptor() ([]byte, []int) {
	return file_common_types_base_types_proto_rawDescGZIP(), []int{41}
}
...
const file_common_types_base_types_proto_rawDesc = "" +
	...
	"\x03end\x18\x04 \x01(\v2\x1b.kiapi.common.types.Vector2R\x03end\"\x88\x02\n" +
	"\x18GraphicEllipseAttributes\x123\n" +
	"\x06center\x18\x01 \x01(\v2\x1b.kiapi.common.types.Vector2R\x06center\x12?\n" +
	"\fmajor_radius\x18\x02 \x01(\v2\x1c.kiapi.common.types.DistanceR\vmajorRadius\x12?\n" +
	"\fminor_radius\x18\x03 \x01(\v2\x1c.kiapi.common.types.DistanceR\vminorRadius\x125\n" +
	"\brotation\x18\x04 \x01(\v2\x19.kiapi.common.types.AngleR\brotation\"\xff\x02\n" +
	"\x1bGraphicEllipseArcAttributes\x123\n" +
	"\x06center\x18\x01 \x01(\v2\x1b.kiapi.common.types.Vector2R\x06center\x12?\n" +
	"\fmajor_radius\x18\x02 \x01(\v2\x1c.kiapi.common.types.DistanceR\vmajorRadius\x12?\n" +
	"\fminor_radius\x18\x03 \x01(\v2\x1c.kiapi.common.types.DistanceR\vminorRadius\x125\n" +
	"\brotation\x18\x04 \x01(\v2\x19.kiapi.common.types.AngleR\brotation\x12:\n" +
	"\vstart_angle\x18\x05 \x01(\v2\x19.kiapi.common.types.AngleR\n" +
	"startAngle\x126\n" +
	"\tend_angle\x18\x06 \x01(\v2\x19.kiapi.common.types.AngleR\bendAngle\"\x9e\x05\n" +
	"\fGraphicShape\x12E\n" +
	"\n" +
	...
	"\x06bezier\x18\t \x01(\v2+.kiapi.common.types.GraphicBezierAttributesH\x00R\x06bezier\x12H\n" +
	"\aellipse\x18\n" +
	" \x01(\v2,.kiapi.common.types.GraphicEllipseAttributesH\x00R\aellipse\x12R\n" +
	"\vellipse_arc\x18\v \x01(\v2/.kiapi.common.types.GraphicEllipseArcAttributesH\x00R\n" +
	"ellipseArcB\n" +
	"\n" +
	"\bgeometry\"I\n" +
	"\rCompoundShape\x128\n" +
...
var file_common_types_base_types_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_common_types_base_types_proto_goTypes = []any{
	...
	(*GraphicEllipseAttributes)(nil),    // 45: kiapi.common.types.GraphicEllipseAttributes
	(*GraphicEllipseArcAttributes)(nil), // 46: kiapi.common.types.GraphicEllipseArcAttributes
	(*GraphicShape)(nil),                // 47: kiapi.common.types.GraphicShape
	(*CompoundShape)(nil),               // 48: kiapi.common.types.CompoundShape
	(*TitleBlockInfo)(nil),              // 49: kiapi.common.types.TitleBlockInfo
	(*RuleCheckerMarkerID)(nil),         // 50: kiapi.common.types.RuleCheckerMarkerID
	(*RuleCheckerMarker)(nil),           // 51: kiapi.common.types.RuleCheckerMarker
	(*MinOptMax)(nil),                   // 52: kiapi.common.types.MinOptMax
	(*PageSettings)(nil),                // 53: kiapi.common.types.PageSettings
	(*fieldmaskpb.FieldMask)(nil),       // 54: google.protobuf.FieldMask
	(HorizontalAlignment)(0),            // 55: kiapi.common.types.HorizontalAlignment
	(VerticalAlignment)(0),              // 56: kiapi.common.types.VerticalAlignment
	(StrokeLineStyle)(0),                // 57: kiapi.common.types.StrokeLineStyle
}
var file_common_types_base_types_proto_depIdxs = []int32{
	...
	54, // 8: kiapi.common.types.ItemHeader.field_mask:type_name -> google.protobuf.FieldMask
	...
	55, // 20: kiapi.common.types.TextAttributes.horizontal_alignment:type_name -> kiapi.common.types.HorizontalAlignment
	56, // 21: kiapi.common.types.TextAttributes.vertical_alignment:type_name -> kiapi.common.types.VerticalAlignment
	...
	57, // 32: kiapi.common.types.StrokeAttributes.style:type_name -> kiapi.common.types.StrokeLineStyle
	...
	20, // 52: kiapi.common.types.GraphicEllipseAttributes.center:type_name -> kiapi.common.types.Vector2
	24, // 53: kiapi.common.types.GraphicEllipseAttributes.major_radius:type_name -> kiapi.common.types.Distance
	24, // 54: kiapi.common.types.GraphicEllipseAttributes.minor_radius:type_name -> kiapi.common.types.Distance
	25, // 55: kiapi.common.types.GraphicEllipseAttributes.rotation:type_name -> kiapi.common.types.Angle
	20, // 56: kiapi.common.types.GraphicEllipseArcAttributes.center:type_name -> kiapi.common.types.Vector2
	24, // 57: kiapi.common.types.GraphicEllipseArcAttributes.major_radius:type_name -> kiapi.common.types.Distance
	24, // 58: kiapi.common.types.GraphicEllipseArcAttributes.minor_radius:type_name -> kiapi.common.types.Distance
	25, // 59: kiapi.common.types.GraphicEllipseArcAttributes.rotation:type_name -> kiapi.common.types.Angle
	25, // 60: kiapi.common.types.GraphicEllipseArcAttributes.start_angle:type_name -> kiapi.common.types.Angle
	25, // 61: kiapi.common.types.GraphicEllipseArcAttributes.end_angle:type_name -> kiapi.common.types.Angle
	39, // 62: kiapi.common.types.GraphicShape.attributes:type_name -> kiapi.common.types.GraphicAttributes
	40, // 63: kiapi.common.types.GraphicShape.segment:type_name -> kiapi.common.types.GraphicSegmentAttributes
	41, // 64: kiapi.common.types.GraphicShape.rectangle:type_name -> kiapi.common.types.GraphicRectangleAttributes
	42, // 65: kiapi.common.types.GraphicShape.arc:type_name -> kiapi.common.types.GraphicArcAttributes
	43, // 66: kiapi.common.types.GraphicShape.circle:type_name -> kiapi.common.types.GraphicCircleAttributes
	33, // 67: kiapi.common.types.GraphicShape.polygon:type_name -> kiapi.common.types.PolySet
	44, // 68: kiapi.common.types.GraphicShape.bezier:type_name -> kiapi.common.types.GraphicBezierAttributes
	45, // 69: kiapi.common.types.GraphicShape.ellipse:type_name -> kiapi.common.types.GraphicEllipseAttributes
	46, // 70: kiapi.common.types.GraphicShape.ellipse_arc:type_name -> kiapi.common.types.GraphicEllipseArcAttributes
	47, // 71: kiapi.common.types.CompoundShape.shapes:type_name -> kiapi.common.types.GraphicShape
	50, // 72: kiapi.common.types.RuleCheckerMarker.id:type_name -> kiapi.common.types.RuleCheckerMarkerID
	10, // 73: kiapi.common.types.PageSettings.page_size:type_name -> kiapi.common.types.PageSize
	20, // 74: kiapi.common.types.PageSettings.user_page_size:type_name -> kiapi.common.types.Vector2
	11, // 75: kiapi.common.types.PageSettings.orientation:type_name -> kiapi.common.types.PageOrientation
...
func file_common_types_base_types_proto_init() {
	...
	file_common_types_base_types_proto_msgTypes[35].OneofWrappers = []any{
		...
		(*GraphicShape_Ellipse)(nil),
		(*GraphicShape_EllipseArc)(nil),
	}
	file_common_types_base_types_proto_msgTypes[40].OneofWrappers = []any{}
	type x struct{}
