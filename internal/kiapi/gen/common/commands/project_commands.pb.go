...
type NetClassesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NetClasses    []*project.NetClass    `protobuf:"bytes,1,rep,name=net_classes,json=netClasses,proto3" json:"net_classes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NetClassesResponse) GetNetClasses() []*project.NetClass {
	if x != nil {
		return x.NetClasses
	}
	return nil
...
func (x *SetNetClasses) GetNetClasses() []*project.NetClass {
	if x != nil {
		return x.NetClasses
	}
	return nil
...
type SetTextVariables struct {
	state     protoimpl.MessageState   `protogen:"open.v1"`
	Document  *types.DocumentSpecifier `protobuf:"bytes,1,opt,name=document,proto3" json:"document,omitempty"`
	Variables *project.TextVariables   `protobuf:"bytes,2,opt,name=variables,proto3" json:"variables,omitempty"`
...
func (x *SetTextVariables) GetVariables() *project.TextVariables {
	if x != nil {
		return x.Variables
	}
	return nil
...
func (x *OpenDocument) GetType() types.DocumentType {
	if x != nil {
		return x.Type
	}
...
func (x *OpenDocumentResponse) GetDocument() *types.DocumentSpecifier {
	if x != nil {
		return x.Document
	}
	return nil
...
func (x *CloseDocument) GetDocument() *types.DocumentSpecifier {
	if x != nil {
		return x.Document
	}
	return nil
...
var file_common_commands_project_commands_proto_goTypes = []any{
	...
	(*project.NetClass)(nil),            // 11: kiapi.common.project.NetClass
	(types.MapMergeMode)(0),             // 12: kiapi.common.types.MapMergeMode
	(*types.DocumentSpecifier)(nil),     // 13: kiapi.common.types.DocumentSpecifier
	(*project.TextVariables)(nil),       // 14: kiapi.common.project.TextVariables
	(types.DocumentType)(0),             // 15: kiapi.common.types.DocumentType
}
