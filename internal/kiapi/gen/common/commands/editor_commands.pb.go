...
type OpenLibraryItem struct {
	...
	Identifier    *types.LibraryIdentifier `protobuf:"bytes,2,opt,name=identifier,proto3" json:"identifier,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OpenLibraryItem) Reset() {
	*x = OpenLibraryItem{}
...
func (x *OpenLibraryItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpenLibraryItem) ProtoMessage() {}

func (x *OpenLibraryItem) ProtoReflect() protoreflect.Message {
	mi := &file_common_commands_editor_commands_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpenLibraryItem.ProtoReflect.Descriptor instead.
func (*OpenLibraryItem) Descriptor() ([]byte, []int) {
	return file_common_commands_editor_commands_proto_rawDescGZIP(), []int{1}
}

func (x *OpenLibraryItem) GetType() types.DocumentType {
	if x != nil {
		return x.Type
	}
...
func (x *OpenLibraryItem) GetIdentifier() *types.LibraryIdentifier {
	if x != nil {
		return x.Identifier
	}
	return nil
...
func (x *BeginCommit) GetHeader() *types.ItemHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
type EndCommit struct {
	...
	// Specifies which document to associate the commit with
	Header        *types.ItemHeader `protobuf:"bytes,4,opt,name=header,proto3" json:"header,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EndCommit) GetHeader() *types.ItemHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GetItemsById) GetHeader() *types.ItemHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GetItemsById) GetItems() []*types.KIID {
	if x != nil {
		return x.Items
	}
	return nil
...
type SetTitleBlockInfo struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Document      *types.DocumentSpecifier `protobuf:"bytes,1,opt,name=document,proto3" json:"document,omitempty"`
	TitleBlock    *types.TitleBlockInfo    `protobuf:"bytes,2,opt,name=title_block,json=titleBlock,proto3" json:"title_block,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetTitleBlockInfo) GetDocument() *types.DocumentSpecifier {
	if x != nil {
		return x.Document
	}
	return nil
...
func (x *SetTitleBlockInfo) GetTitleBlock() *types.TitleBlockInfo {
	if x != nil {
		return x.TitleBlock
	}
	return nil
...
func (x *GetPageSettings) GetDocument() *types.DocumentSpecifier {
	if x != nil {
		return x.Document
	}
	return nil
...
type SetPageSettings struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Document      *types.DocumentSpecifier `protobuf:"bytes,1,opt,name=document,proto3" json:"document,omitempty"`
	PageSettings  *types.PageSettings      `protobuf:"bytes,2,opt,name=page_settings,json=pageSettings,proto3" json:"page_settings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetPageSettings) GetDocument() *types.DocumentSpecifier {
	if x != nil {
		return x.Document
	}
	return nil
...
func (x *SetPageSettings) GetPageSettings() *types.PageSettings {
	if x != nil {
...
func (x *ParseAndCreateItemsFromString) Reset() {
	*x = ParseAndCreateItemsFromString{}
	mi := &file_common_commands_editor_commands_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ParseAndCreateItemsFromString) Descriptor() ([]byte, []int) {
	return file_common_commands_editor_commands_proto_rawDescGZIP(), []int{43}
}
...
const file_common_commands_editor_commands_proto_rawDesc = "" +
	...
	"\rRefreshEditor\x123\n" +
	"\x05frame\x18\x01 \x01(\x0e2\x1d.kiapi.common.types.FrameTypeR\x05frame\"\x8e\x01\n" +
	"\x0fOpenLibraryItem\x124\n" +
	"\x04type\x18\x01 \x01(\x0e2 .kiapi.common.types.DocumentTypeR\x04type\x12E\n" +
	"\n" +
	"identifier\x18\x02 \x01(\v2%.kiapi.common.types.LibraryIdentifierR\n" +
	"identifier\"H\n" +
...
var file_common_commands_editor_commands_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_common_commands_editor_commands_proto_goTypes = []any{
	...
	(*OpenLibraryItem)(nil),               // 7: kiapi.common.commands.OpenLibraryItem
	(*GetOpenDocuments)(nil),              // 8: kiapi.common.commands.GetOpenDocuments
	(*GetOpenDocumentsResponse)(nil),      // 9: kiapi.common.commands.GetOpenDocumentsResponse
	...
	(*GetItemsById)(nil),                  // 24: kiapi.common.commands.GetItemsById
	(*GetItemsResponse)(nil),              // 25: kiapi.common.commands.GetItemsResponse
	(*UpdateItems)(nil),                   // 26: kiapi.common.commands.UpdateItems
	(*ItemUpdateResult)(nil),              // 27: kiapi.common.commands.ItemUpdateResult
	(*UpdateItemsResponse)(nil),           // 28: kiapi.common.commands.UpdateItemsResponse
	(*DeleteItems)(nil),                   // 29: kiapi.common.commands.DeleteItems
	(*ItemDeletionResult)(nil),            // 30: kiapi.common.commands.ItemDeletionResult
	(*DeleteItemsResponse)(nil),           // 31: kiapi.common.commands.DeleteItemsResponse
	(*GetBoundingBox)(nil),                // 32: kiapi.common.commands.GetBoundingBox
	(*GetBoundingBoxResponse)(nil),        // 33: kiapi.common.commands.GetBoundingBoxResponse
	(*GetSelection)(nil),                  // 34: kiapi.common.commands.GetSelection
	(*SelectionResponse)(nil),             // 35: kiapi.common.commands.SelectionResponse
	(*AddToSelection)(nil),                // 36: kiapi.common.commands.AddToSelection
	(*RemoveFromSelection)(nil),           // 37: kiapi.common.commands.RemoveFromSelection
	(*ClearSelection)(nil),                // 38: kiapi.common.commands.ClearSelection
	(*HitTest)(nil),                       // 39: kiapi.common.commands.HitTest
	(*HitTestResponse)(nil),               // 40: kiapi.common.commands.HitTestResponse
	(*GetTitleBlockInfo)(nil),             // 41: kiapi.common.commands.GetTitleBlockInfo
	(*SetTitleBlockInfo)(nil),             // 42: kiapi.common.commands.SetTitleBlockInfo
	(*GetPageSettings)(nil),               // 43: kiapi.common.commands.GetPageSettings
	(*SetPageSettings)(nil),               // 44: kiapi.common.commands.SetPageSettings
	(*SaveDocumentToString)(nil),          // 45: kiapi.common.commands.SaveDocumentToString
	(*SavedDocumentResponse)(nil),         // 46: kiapi.common.commands.SavedDocumentResponse
	(*SaveSelectionToString)(nil),         // 47: kiapi.common.commands.SaveSelectionToString
	(*SavedSelectionResponse)(nil),        // 48: kiapi.common.commands.SavedSelectionResponse
	(*ParseAndCreateItemsFromString)(nil), // 49: kiapi.common.commands.ParseAndCreateItemsFromString
	(types.FrameType)(0),                  // 50: kiapi.common.types.FrameType
	(types.DocumentType)(0),               // 51: kiapi.common.types.DocumentType
	(*types.LibraryIdentifier)(nil),       // 52: kiapi.common.types.LibraryIdentifier
	(*types.DocumentSpecifier)(nil),       // 53: kiapi.common.types.DocumentSpecifier
	(*types.ItemHeader)(nil),              // 54: kiapi.common.types.ItemHeader
	(*types.KIID)(nil),                    // 55: kiapi.common.types.KIID
	(*anypb.Any)(nil),                     // 56: google.protobuf.Any
	(types.ItemRequestStatus)(0),          // 57: kiapi.common.types.ItemRequestStatus
	(types.KiCadObjectType)(0),            // 58: kiapi.common.types.KiCadObjectType
	(*types.Box2)(nil),                    // 59: kiapi.common.types.Box2
	(*types.Vector2)(nil),                 // 60: kiapi.common.types.Vector2
	(*types.TitleBlockInfo)(nil),          // 61: kiapi.common.types.TitleBlockInfo
	(*types.PageSettings)(nil),            // 62: kiapi.common.types.PageSettings
}
var file_common_commands_editor_commands_proto_depIdxs = []int32{
	50, // 0: kiapi.common.commands.RefreshEditor.frame:type_name -> kiapi.common.types.FrameType
	51, // 1: kiapi.common.commands.OpenLibraryItem.type:type_name -> kiapi.common.types.DocumentType
	52, // 2: kiapi.common.commands.OpenLibraryItem.identifier:type_name -> kiapi.common.types.LibraryIdentifier
	51, // 3: kiapi.common.commands.GetOpenDocuments.type:type_name -> kiapi.common.types.DocumentType
	53, // 4: kiapi.common.commands.GetOpenDocumentsResponse.documents:type_name -> kiapi.common.types.DocumentSpecifier
	53, // 5: kiapi.common.commands.SaveCopyOfDocument.document:type_name -> kiapi.common.types.DocumentSpecifier
	10, // 6: kiapi.common.commands.SaveCopyOfDocument.options:type_name -> kiapi.common.commands.SaveOptions
	53, // 7: kiapi.common.commands.RevertDocument.document:type_name -> kiapi.common.types.DocumentSpecifier
	0,  // 8: kiapi.common.commands.RunActionResponse.status:type_name -> kiapi.common.commands.RunActionStatus
	54, // 9: kiapi.common.commands.BeginCommit.header:type_name -> kiapi.common.types.ItemHeader
	55, // 10: kiapi.common.commands.BeginCommitResponse.id:type_name -> kiapi.common.types.KIID
	55, // 11: kiapi.common.commands.EndCommit.id:type_name -> kiapi.common.types.KIID
	1,  // 12: kiapi.common.commands.EndCommit.action:type_name -> kiapi.common.commands.CommitAction
	54, // 13: kiapi.common.commands.EndCommit.header:type_name -> kiapi.common.types.ItemHeader
	54, // 14: kiapi.common.commands.CreateItems.header:type_name -> kiapi.common.types.ItemHeader
	56, // 15: kiapi.common.commands.CreateItems.items:type_name -> google.protobuf.Any
	55, // 16: kiapi.common.commands.CreateItems.container:type_name -> kiapi.common.types.KIID
	2,  // 17: kiapi.common.commands.ItemStatus.code:type_name -> kiapi.common.commands.ItemStatusCode
	20, // 18: kiapi.common.commands.ItemCreationResult.status:type_name -> kiapi.common.commands.ItemStatus
	56, // 19: kiapi.common.commands.ItemCreationResult.item:type_name -> google.protobuf.Any
	54, // 20: kiapi.common.commands.CreateItemsResponse.header:type_name -> kiapi.common.types.ItemHeader
	57, // 21: kiapi.common.commands.CreateItemsResponse.status:type_name -> kiapi.common.types.ItemRequestStatus
	21, // 22: kiapi.common.commands.CreateItemsResponse.created_items:type_name -> kiapi.common.commands.ItemCreationResult
	54, // 23: kiapi.common.commands.GetItems.header:type_name -> kiapi.common.types.ItemHeader
	58, // 24: kiapi.common.commands.GetItems.types:type_name -> kiapi.common.types.KiCadObjectType
	54, // 25: kiapi.common.commands.GetItemsById.header:type_name -> kiapi.common.types.ItemHeader
	55, // 26: kiapi.common.commands.GetItemsById.items:type_name -> kiapi.common.types.KIID
	54, // 27: kiapi.common.commands.GetItemsResponse.header:type_name -> kiapi.common.types.ItemHeader
	57, // 28: kiapi.common.commands.GetItemsResponse.status:type_name -> kiapi.common.types.ItemRequestStatus
	56, // 29: kiapi.common.commands.GetItemsResponse.items:type_name -> google.protobuf.Any
	54, // 30: kiapi.common.commands.UpdateItems.header:type_name -> kiapi.common.types.ItemHeader
	56, // 31: kiapi.common.commands.UpdateItems.items:type_name -> google.protobuf.Any
	20, // 32: kiapi.common.commands.ItemUpdateResult.status:type_name -> kiapi.common.commands.ItemStatus
	56, // 33: kiapi.common.commands.ItemUpdateResult.item:type_name -> google.protobuf.Any
	54, // 34: kiapi.common.commands.UpdateItemsResponse.header:type_name -> kiapi.common.types.ItemHeader
	57, // 35: kiapi.common.commands.UpdateItemsResponse.status:type_name -> kiapi.common.types.ItemRequestStatus
	27, // 36: kiapi.common.commands.UpdateItemsResponse.updated_items:type_name -> kiapi.common.commands.ItemUpdateResult
	54, // 37: kiapi.common.commands.DeleteItems.header:type_name -> kiapi.common.types.ItemHeader
	55, // 38: kiapi.common.commands.DeleteItems.item_ids:type_name -> kiapi.common.types.KIID
	55, // 39: kiapi.common.commands.ItemDeletionResult.id:type_name -> kiapi.common.types.KIID
	3,  // 40: kiapi.common.commands.ItemDeletionResult.status:type_name -> kiapi.common.commands.ItemDeletionStatus
	54, // 41: kiapi.common.commands.DeleteItemsResponse.header:type_name -> kiapi.common.types.ItemHeader
	57, // 42: kiapi.common.commands.DeleteItemsResponse.status:type_name -> kiapi.common.types.ItemRequestStatus
	30, // 43: kiapi.common.commands.DeleteItemsResponse.deleted_items:type_name -> kiapi.common.commands.ItemDeletionResult
	54, // 44: kiapi.common.commands.GetBoundingBox.header:type_name -> kiapi.common.types.ItemHeader
	55, // 45: kiapi.common.commands.GetBoundingBox.items:type_name -> kiapi.common.types.KIID
	4,  // 46: kiapi.common.commands.GetBoundingBox.mode:type_name -> kiapi.common.commands.BoundingBoxMode
	55, // 47: kiapi.common.commands.GetBoundingBoxResponse.items:type_name -> kiapi.common.types.KIID
	59, // 48: kiapi.common.commands.GetBoundingBoxResponse.boxes:type_name -> kiapi.common.types.Box2
	54, // 49: kiapi.common.commands.GetSelection.header:type_name -> kiapi.common.types.ItemHeader
	58, // 50: kiapi.common.commands.GetSelection.types:type_name -> kiapi.common.types.KiCadObjectType
	56, // 51: kiapi.common.commands.SelectionResponse.items:type_name -> google.protobuf.Any
	54, // 52: kiapi.common.commands.AddToSelection.header:type_name -> kiapi.common.types.ItemHeader
	55, // 53: kiapi.common.commands.AddToSelection.items:type_name -> kiapi.common.types.KIID
	54, // 54: kiapi.common.commands.RemoveFromSelection.header:type_name -> kiapi.common.types.ItemHeader
	55, // 55: kiapi.common.commands.RemoveFromSelection.items:type_name -> kiapi.common.types.KIID
	54, // 56: kiapi.common.commands.ClearSelection.header:type_name -> kiapi.common.types.ItemHeader
	54, // 57: kiapi.common.commands.HitTest.header:type_name -> kiapi.common.types.ItemHeader
	55, // 58: kiapi.common.commands.HitTest.id:type_name -> kiapi.common.types.KIID
	60, // 59: kiapi.common.commands.HitTest.position:type_name -> kiapi.common.types.Vector2
	5,  // 60: kiapi.common.commands.HitTestResponse.result:type_name -> kiapi.common.commands.HitTestResult
	53, // 61: kiapi.common.commands.GetTitleBlockInfo.document:type_name -> kiapi.common.types.DocumentSpecifier
	53, // 62: kiapi.common.commands.SetTitleBlockInfo.document:type_name -> kiapi.common.types.DocumentSpecifier
	61, // 63: kiapi.common.commands.SetTitleBlockInfo.title_block:type_name -> kiapi.common.types.TitleBlockInfo
	53, // 64: kiapi.common.commands.GetPageSettings.document:type_name -> kiapi.common.types.DocumentSpecifier
	53, // 65: kiapi.common.commands.SetPageSettings.document:type_name -> kiapi.common.types.DocumentSpecifier
	62, // 66: kiapi.common.commands.SetPageSettings.page_settings:type_name -> kiapi.common.types.PageSettings
	53, // 67: kiapi.common.commands.SaveDocumentToString.document:type_name -> kiapi.common.types.DocumentSpecifier
	53, // 68: kiapi.common.commands.SavedDocumentResponse.document:type_name -> kiapi.common.types.DocumentSpecifier
	55, // 69: kiapi.common.commands.SavedSelectionResponse.ids:type_name -> kiapi.common.types.KIID
	53, // 70: kiapi.common.commands.ParseAndCreateItemsFromString.document:type_name -> kiapi.common.types.DocumentSpecifier
