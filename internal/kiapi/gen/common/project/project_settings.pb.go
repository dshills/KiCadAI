...
type NetClassBoardSettings struct {
	...
	Clearance          *types.Distance        `protobuf:"bytes,1,opt,name=clearance,proto3,oneof" json:"clearance,omitempty"`
	TrackWidth         *types.Distance        `protobuf:"bytes,2,opt,name=track_width,json=trackWidth,proto3,oneof" json:"track_width,omitempty"`
	DiffPairTrackWidth *types.Distance        `protobuf:"bytes,3,opt,name=diff_pair_track_width,json=diffPairTrackWidth,proto3,oneof" json:"diff_pair_track_width,omitempty"`
	DiffPairGap        *types.Distance        `protobuf:"bytes,4,opt,name=diff_pair_gap,json=diffPairGap,proto3,oneof" json:"diff_pair_gap,omitempty"`
	DiffPairViaGap     *types.Distance        `protobuf:"bytes,5,opt,name=diff_pair_via_gap,json=diffPairViaGap,proto3,oneof" json:"diff_pair_via_gap,omitempty"`
	...
	ViaStack *types1.PadStack `protobuf:"bytes,6,opt,name=via_stack,json=viaStack,proto3,oneof" json:"via_stack,omitempty"`
	// The default padstack to use for microvias belonging to this netclass
	// Currently KiCad only supports specifying the drill diameter and annular size on all layers for
	// netclass via stacks.  Complex padstacks and other via features cannot be specified here.
	MicroviaStack *types1.PadStack `protobuf:"bytes,7,opt,name=microvia_stack,json=microviaStack,proto3,oneof" json:"microvia_stack,omitempty"`
	Color         *types.Color     `protobuf:"bytes,8,opt,name=color,proto3,oneof" json:"color,omitempty"`
	// Since 10.0.0
...
func (x *NetClassBoardSettings) GetClearance() *types.Distance {
	if x != nil {
		return x.Clearance
	}
	return nil
...
func (x *NetClassBoardSettings) GetTrackWidth() *types.Distance {
	if x != nil {
		return x.TrackWidth
	}
	return nil
...
func (x *NetClassBoardSettings) GetDiffPairTrackWidth() *types.Distance {
	if x != nil {
...
func (x *NetClassBoardSettings) GetDiffPairGap() *types.Distance {
	if x != nil {
...
func (x *NetClassBoardSettings) GetDiffPairViaGap() *types.Distance {
	if x != nil {
...
func (x *NetClassBoardSettings) GetViaStack() *types1.PadStack {
	if x != nil {
		return x.ViaStack
	}
	return nil
...
func (x *NetClassBoardSettings) GetMicroviaStack() *types1.PadStack {
	if x != nil {
...
func (x *NetClassBoardSettings) GetColor() *types.Color {
	if x != nil {
		return x.Color
	}
	return nil
...
type NetClassSchematicSettings struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WireWidth     *types.Distance        `protobuf:"bytes,1,opt,name=wire_width,json=wireWidth,proto3,oneof" json:"wire_width,omitempty"`
	BusWidth      *types.Distance        `protobuf:"bytes,2,opt,name=bus_width,json=busWidth,proto3,oneof" json:"bus_width,omitempty"`
	Color         *types.Color           `protobuf:"bytes,3,opt,name=color,proto3,oneof" json:"color,omitempty"`
	LineStyle     *types.StrokeLineStyle `protobuf:"varint,4,opt,name=line_style,json=lineStyle,proto3,enum=kiapi.common.types.StrokeLineStyle,oneof" json:"line_style,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NetClassSchematicSettings) GetWireWidth() *types.Distance {
	if x != nil {
		return x.WireWidth
	}
	return nil
...
func (x *NetClassSchematicSettings) GetBusWidth() *types.Distance {
	if x != nil {
		return x.BusWidth
	}
	return nil
...
func (x *NetClassSchematicSettings) GetColor() *types.Color {
	if x != nil {
		return x.Color
	}
	return nil
...
func (x *NetClassSchematicSettings) GetLineStyle() types.StrokeLineStyle {
	if x != nil && x.LineStyle != nil {
		return *x.LineStyle
	}
	return types.StrokeLineStyle(0)
}
...
var file_common_types_project_settings_proto_goTypes = []any{
	...
	(*types.Distance)(nil),            // 6: kiapi.common.types.Distance
	(*types1.PadStack)(nil),           // 7: kiapi.board.types.PadStack
	(*types.Color)(nil),               // 8: kiapi.common.types.Color
	(types.StrokeLineStyle)(0),        // 9: kiapi.common.types.StrokeLineStyle
}
