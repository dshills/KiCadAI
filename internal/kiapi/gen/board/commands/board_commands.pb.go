...
package boardcommands

import (
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	board "kicadai/internal/kiapi/gen/board"
	types1 "kicadai/internal/kiapi/gen/board/types"
	project "kicadai/internal/kiapi/gen/common/project"
...
type NetlistMatchMode int32

const (
	NetlistMatchMode_NMM_UNKNOWN   NetlistMatchMode = 0
	NetlistMatchMode_NMM_UUID      NetlistMatchMode = 1 // Match by unique ID.
	NetlistMatchMode_NMM_REFERENCE NetlistMatchMode = 2 // Match by reference designator.
)

// Enum value maps for NetlistMatchMode.
var (
	NetlistMatchMode_name = map[int32]string{
		0: "NMM_UNKNOWN",
		1: "NMM_UUID",
		2: "NMM_REFERENCE",
	}
	NetlistMatchMode_value = map[string]int32{
		"NMM_UNKNOWN":   0,
		"NMM_UUID":      1,
		"NMM_REFERENCE": 2,
	}
...
func (x NetlistMatchMode) Enum() *NetlistMatchMode {
	p := new(NetlistMatchMode)
	*p = x
	return p
}

func (x NetlistMatchMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NetlistMatchMode) Descriptor() protoreflect.EnumDescriptor {
	return file_board_board_commands_proto_enumTypes[2].Descriptor()
}

func (NetlistMatchMode) Type() protoreflect.EnumType {
	return &file_board_board_commands_proto_enumTypes[2]
}

func (x NetlistMatchMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NetlistMatchMode.Descriptor instead.
func (NetlistMatchMode) EnumDescriptor() ([]byte, []int) {
...
func (RatsnestDisplayMode) Descriptor() protoreflect.EnumDescriptor {
	return file_board_board_commands_proto_enumTypes[8].Descriptor()
}

func (RatsnestDisplayMode) Type() protoreflect.EnumType {
	return &file_board_board_commands_proto_enumTypes[8]
}
...
func (x *GetBoardEnabledLayers) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
type BoardEnabledLayersResponse struct {
	...
	Layers        []types1.BoardLayer `protobuf:"varint,2,rep,packed,name=layers,proto3,enum=kiapi.board.types.BoardLayer" json:"layers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BoardEnabledLayersResponse) GetLayers() []types1.BoardLayer {
	if x != nil {
		return x.Layers
	}
	return nil
...
type SetBoardEnabledLayers struct {
	...
	Layers        []types1.BoardLayer `protobuf:"varint,3,rep,packed,name=layers,proto3,enum=kiapi.board.types.BoardLayer" json:"layers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetBoardEnabledLayers) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *SetBoardEnabledLayers) GetLayers() []types1.BoardLayer {
	if x != nil {
		return x.Layers
	}
	return nil
...
func (x *GetBoardDesignRules) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *SetBoardDesignRules) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *GetCustomDesignRules) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *SetCustomDesignRules) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
type GetBoardLayerName struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Board         *types.DocumentSpecifier `protobuf:"bytes,1,opt,name=board,proto3" json:"board,omitempty"`
	Layer         types1.BoardLayer        `protobuf:"varint,2,opt,name=layer,proto3,enum=kiapi.board.types.BoardLayer" json:"layer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetBoardLayerName) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *GetBoardLayerName) GetLayer() types1.BoardLayer {
	if x != nil {
		return x.Layer
	}
	return types1.BoardLayer(0)
}
...
type NetsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Nets          []*types1.Net          `protobuf:"bytes,1,rep,name=nets,proto3" json:"nets,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NetsResponse) GetNets() []*types1.Net {
	if x != nil {
		return x.Nets
	}
	return nil
...
type GetItemsByNet struct {
	...
	Nets          []*types1.Net `protobuf:"bytes,4,rep,name=nets,proto3" json:"nets,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetItemsByNet) GetNets() []*types1.Net {
	if x != nil {
		return x.Nets
	}
	return nil
...
type GetConnectedItems struct {
	...
	Types         []types.KiCadObjectType `protobuf:"varint,3,rep,packed,name=types,proto3,enum=kiapi.common.types.KiCadObjectType" json:"types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConnectedItems) GetHeader() *types.ItemHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GetConnectedItems) GetItems() []*types.KIID {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *GetConnectedItems) GetTypes() []types.KiCadObjectType {
	if x != nil {
		return x.Types
	}
	return nil
...
type GetNetClassForNets struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Net           []*types1.Net          `protobuf:"bytes,1,rep,name=net,proto3" json:"net,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetNetClassForNets) GetNet() []*types1.Net {
	if x != nil {
		return x.Net
	}
	return nil
...
type NetClassForNetsResponse struct {
	...
	Classes       map[string]*project.NetClass `protobuf:"bytes,1,rep,name=classes,proto3" json:"classes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NetClassForNetsResponse) GetClasses() map[string]*project.NetClass {
	if x != nil {
		return x.Classes
	}
	return nil
...
type ImportNetlist struct {
	state protoimpl.MessageState   `protogen:"open.v1"`
	Board *types.DocumentSpecifier `protobuf:"bytes,1,opt,name=board,proto3" json:"board,omitempty"`
	// Path to the netlist file.
	NetlistPath string `protobuf:"bytes,2,opt,name=netlist_path,json=netlistPath,proto3" json:"netlist_path,omitempty"`
	// If true, report planned changes without modifying the board.
	DryRun                bool             `protobuf:"varint,3,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"`
	MatchMode             NetlistMatchMode `protobuf:"varint,4,opt,name=match_mode,json=matchMode,proto3,enum=kiapi.board.commands.NetlistMatchMode" json:"match_mode,omitempty"`
	DeleteExtraFootprints bool             `protobuf:"varint,5,opt,name=delete_extra_footprints,json=deleteExtraFootprints,proto3" json:"delete_extra_footprints,omitempty"`
	UpdateFootprints      bool             `protobuf:"varint,6,opt,name=update_footprints,json=updateFootprints,proto3" json:"update_footprints,omitempty"`
	TransferGroups        bool             `protobuf:"varint,7,opt,name=transfer_groups,json=transferGroups,proto3" json:"transfer_groups,omitempty"`
	OverrideLocks         bool             `protobuf:"varint,8,opt,name=override_locks,json=overrideLocks,proto3" json:"override_locks,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *ImportNetlist) Reset() {
	*x = ImportNetlist{}
...
func (x *ImportNetlist) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportNetlist) ProtoMessage() {}

func (x *ImportNetlist) ProtoReflect() protoreflect.Message {
	mi := &file_board_board_commands_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImportNetlist.ProtoReflect.Descriptor instead.
func (*ImportNetlist) Descriptor() ([]byte, []int) {
	return file_board_board_commands_proto_rawDescGZIP(), []int{25}
}

func (x *ImportNetlist) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *ImportNetlist) GetNetlistPath() string {
	if x != nil {
		return x.NetlistPath
	}
	return ""
}

func (x *ImportNetlist) GetDryRun() bool {
	if x != nil {
		return x.DryRun
	}
	return false
...
func (x *ImportNetlist) GetMatchMode() NetlistMatchMode {
	if x != nil {
		return x.MatchMode
	}
	return NetlistMatchMode_NMM_UNKNOWN
}

func (x *ImportNetlist) GetDeleteExtraFootprints() bool {
	if x != nil {
		return x.DeleteExtraFootprints
	}
	return false
}

func (x *ImportNetlist) GetUpdateFootprints() bool {
	if x != nil {
		return x.UpdateFootprints
	}
	return false
}

func (x *ImportNetlist) GetTransferGroups() bool {
	if x != nil {
		return x.TransferGroups
	}
	return false
}

func (x *ImportNetlist) GetOverrideLocks() bool {
	if x != nil {
		return x.OverrideLocks
	}
	return false
}

type ImportNetlistResponse struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	ErrorCount        uint32                 `protobuf:"varint,1,opt,name=error_count,json=errorCount,proto3" json:"error_count,omitempty"`
	WarningCount      uint32                 `protobuf:"varint,2,opt,name=warning_count,json=warningCount,proto3" json:"warning_count,omitempty"`
	NewFootprintCount uint32                 `protobuf:"varint,3,opt,name=new_footprint_count,json=newFootprintCount,proto3" json:"new_footprint_count,omitempty"`
...
func (x *ImportNetlistResponse) Reset() {
	*x = ImportNetlistResponse{}
	mi := &file_board_board_commands_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ImportNetlistResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportNetlistResponse) ProtoMessage() {}

func (x *ImportNetlistResponse) ProtoReflect() protoreflect.Message {
	mi := &file_board_board_commands_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImportNetlistResponse.ProtoReflect.Descriptor instead.
func (*ImportNetlistResponse) Descriptor() ([]byte, []int) {
	return file_board_board_commands_proto_rawDescGZIP(), []int{26}
}

func (x *ImportNetlistResponse) GetErrorCount() uint32 {
	if x != nil {
		return x.ErrorCount
	}
	return 0
...
func (x *ImportNetlistResponse) GetWarningCount() uint32 {
	if x != nil {
...
func (x *ImportNetlistResponse) GetNewFootprintCount() uint32 {
	if x != nil {
		return x.NewFootprintCount
	}
	return 0
}

func (x *ImportNetlistResponse) GetReport() string {
	if x != nil {
		return x.Report
	}
	return ""
...
type GetPadShapeAsPolygon struct {
	...
	Layer         types1.BoardLayer `protobuf:"varint,3,opt,name=layer,proto3,enum=kiapi.board.types.BoardLayer" json:"layer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetPadShapeAsPolygon) GetLayer() types1.BoardLayer {
	if x != nil {
		return x.Layer
	}
	return types1.BoardLayer(0)
...
func (x *CheckPadstackPresenceOnLayers) GetLayers() []types1.BoardLayer {
	if x != nil {
		return x.Layers
	}
	return nil
...
func (x *PadstackPresenceEntry) GetLayer() types1.BoardLayer {
	if x != nil {
		return x.Layer
	}
	return types1.BoardLayer(0)
...
type InjectDrcError struct {
	...
	Position      *types.Vector2           `protobuf:"bytes,4,opt,name=position,proto3" json:"position,omitempty"`
	Items         []*types.KIID            `protobuf:"bytes,5,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InjectDrcError) GetBoard() *types.DocumentSpecifier {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *InjectDrcError) GetPosition() *types.Vector2 {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *InjectDrcError) GetItems() []*types.KIID {
	if x != nil {
		return x.Items
	}
	return nil
...
type InjectDrcErrorResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Marker        *types.KIID            `protobuf:"bytes,1,opt,name=marker,proto3" json:"marker,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InjectDrcErrorResponse) GetMarker() *types.KIID {
	if x != nil {
		return x.Marker
	}
	return nil
...
type BoardLayerResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Layer         types1.BoardLayer      `protobuf:"varint,1,opt,name=layer,proto3,enum=kiapi.board.types.BoardLayer" json:"layer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BoardLayerResponse) GetLayer() types1.BoardLayer {
	if x != nil {
		return x.Layer
	}
	return types1.BoardLayer(0)
...
type BoardLayers struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Layers        []types1.BoardLayer    `protobuf:"varint,1,rep,packed,name=layers,proto3,enum=kiapi.board.types.BoardLayer" json:"layers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BoardLayers) GetLayers() []types1.BoardLayer {
	if x != nil {
		return x.Layers
	}
	return nil
...
func (x *SetVisibleLayers) GetLayers() []types1.BoardLayer {
	if x != nil {
		return x.Layers
	}
	return nil
...
func (x *SetActiveLayer) GetLayer() types1.BoardLayer {
	if x != nil {
		return x.Layer
	}
	return types1.BoardLayer(0)
...
func (x *SetBoardEditorAppearanceSettings) Reset() {
	*x = SetBoardEditorAppearanceSettings{}
	mi := &file_board_board_commands_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetBoardEditorAppearanceSettings) Descriptor() ([]byte, []int) {
	return file_board_board_commands_proto_rawDescGZIP(), []int{43}
}
...
func (x *InteractiveMoveItems) Reset() {
	*x = InteractiveMoveItems{}
	mi := &file_board_board_commands_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InteractiveMoveItems) Descriptor() ([]byte, []int) {
	return file_board_board_commands_proto_rawDescGZIP(), []int{44}
}
...
const file_board_board_commands_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x1e.kiapi.common.project.NetClassR\x05value:\x028\x01\"\x84\x03\n" +
	"\rImportNetlist\x12;\n" +
	"\x05board\x18\x01 \x01(\v2%.kiapi.common.types.DocumentSpecifierR\x05board\x12!\n" +
	"\fnetlist_path\x18\x02 \x01(\tR\vnetlistPath\x12\x17\n" +
	"\adry_run\x18\x03 \x01(\bR\x06dryRun\x12E\n" +
	"\n" +
	"match_mode\x18\x04 \x01(\x0e2&.kiapi.board.commands.NetlistMatchModeR\tmatchMode\x126\n" +
	"\x17delete_extra_footprints\x18\x05 \x01(\bR\x15deleteExtraFootprints\x12+\n" +
	"\x11update_footprints\x18\x06 \x01(\bR\x10updateFootprints\x12'\n" +
	"\x0ftransfer_groups\x18\a \x01(\bR\x0etransferGroups\x12%\n" +
	"\x0eoverride_locks\x18\b \x01(\bR\roverrideLocks\"\xa5\x01\n" +
	"\x15ImportNetlistResponse\x12\x1f\n" +
	"\verror_count\x18\x01 \x01(\rR\n" +
	"errorCount\x12#\n" +
	"\rwarning_count\x18\x02 \x01(\rR\fwarningCount\x12.\n" +
	"\x13new_footprint_count\x18\x03 \x01(\rR\x11newFootprintCount\x12\x16\n" +
	...
	"\vNMM_UNKNOWN\x10\x00\x12\f\n" +
	"\bNMM_UUID\x10\x01\x12\x11\n" +
...
var file_board_board_commands_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_board_board_commands_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_board_board_commands_proto_goTypes = []any{
	...
	(NetlistMatchMode)(0),                    // 2: kiapi.board.commands.NetlistMatchMode
	(PadstackPresence)(0),                    // 3: kiapi.board.commands.PadstackPresence
	(DrcSeverity)(0),                         // 4: kiapi.board.commands.DrcSeverity
	(InactiveLayerDisplayMode)(0),            // 5: kiapi.board.commands.InactiveLayerDisplayMode
	(NetColorDisplayMode)(0),                 // 6: kiapi.board.commands.NetColorDisplayMode
	(BoardFlipMode)(0),                       // 7: kiapi.board.commands.BoardFlipMode
	(RatsnestDisplayMode)(0),                 // 8: kiapi.board.commands.RatsnestDisplayMode
	(*GetBoardStackup)(nil),                  // 9: kiapi.board.commands.GetBoardStackup
	(*BoardStackupResponse)(nil),             // 10: kiapi.board.commands.BoardStackupResponse
	(*UpdateBoardStackup)(nil),               // 11: kiapi.board.commands.UpdateBoardStackup
	(*GetBoardEnabledLayers)(nil),            // 12: kiapi.board.commands.GetBoardEnabledLayers
	(*BoardEnabledLayersResponse)(nil),       // 13: kiapi.board.commands.BoardEnabledLayersResponse
	(*SetBoardEnabledLayers)(nil),            // 14: kiapi.board.commands.SetBoardEnabledLayers
	(*GetGraphicsDefaults)(nil),              // 15: kiapi.board.commands.GetGraphicsDefaults
	(*GraphicsDefaultsResponse)(nil),         // 16: kiapi.board.commands.GraphicsDefaultsResponse
	(*GetBoardDesignRules)(nil),              // 17: kiapi.board.commands.GetBoardDesignRules
	(*SetBoardDesignRules)(nil),              // 18: kiapi.board.commands.SetBoardDesignRules
	(*BoardDesignRulesResponse)(nil),         // 19: kiapi.board.commands.BoardDesignRulesResponse
	(*GetCustomDesignRules)(nil),             // 20: kiapi.board.commands.GetCustomDesignRules
	(*SetCustomDesignRules)(nil),             // 21: kiapi.board.commands.SetCustomDesignRules
	(*CustomRulesResponse)(nil),              // 22: kiapi.board.commands.CustomRulesResponse
	(*GetBoardOrigin)(nil),                   // 23: kiapi.board.commands.GetBoardOrigin
	(*SetBoardOrigin)(nil),                   // 24: kiapi.board.commands.SetBoardOrigin
	(*GetBoardLayerName)(nil),                // 25: kiapi.board.commands.GetBoardLayerName
	(*BoardLayerNameResponse)(nil),           // 26: kiapi.board.commands.BoardLayerNameResponse
	(*GetNets)(nil),                          // 27: kiapi.board.commands.GetNets
	(*NetsResponse)(nil),                     // 28: kiapi.board.commands.NetsResponse
	(*GetItemsByNet)(nil),                    // 29: kiapi.board.commands.GetItemsByNet
	(*GetItemsByNetClass)(nil),               // 30: kiapi.board.commands.GetItemsByNetClass
	(*GetConnectedItems)(nil),                // 31: kiapi.board.commands.GetConnectedItems
	(*GetNetClassForNets)(nil),               // 32: kiapi.board.commands.GetNetClassForNets
	(*NetClassForNetsResponse)(nil),          // 33: kiapi.board.commands.NetClassForNetsResponse
	(*ImportNetlist)(nil),                    // 34: kiapi.board.commands.ImportNetlist
	(*ImportNetlistResponse)(nil),            // 35: kiapi.board.commands.ImportNetlistResponse
	(*RefillZones)(nil),                      // 36: kiapi.board.commands.RefillZones
	(*GetPadShapeAsPolygon)(nil),             // 37: kiapi.board.commands.GetPadShapeAsPolygon
	(*PadShapeAsPolygonResponse)(nil),        // 38: kiapi.board.commands.PadShapeAsPolygonResponse
	(*CheckPadstackPresenceOnLayers)(nil),    // 39: kiapi.board.commands.CheckPadstackPresenceOnLayers
	(*PadstackPresenceEntry)(nil),            // 40: kiapi.board.commands.PadstackPresenceEntry
	(*PadstackPresenceResponse)(nil),         // 41: kiapi.board.commands.PadstackPresenceResponse
	(*InjectDrcError)(nil),                   // 42: kiapi.board.commands.InjectDrcError
	(*InjectDrcErrorResponse)(nil),           // 43: kiapi.board.commands.InjectDrcErrorResponse
	(*GetVisibleLayers)(nil),                 // 44: kiapi.board.commands.GetVisibleLayers
	(*BoardLayerResponse)(nil),               // 45: kiapi.board.commands.BoardLayerResponse
	(*BoardLayers)(nil),                      // 46: kiapi.board.commands.BoardLayers
	(*SetVisibleLayers)(nil),                 // 47: kiapi.board.commands.SetVisibleLayers
	(*GetActiveLayer)(nil),                   // 48: kiapi.board.commands.GetActiveLayer
	(*SetActiveLayer)(nil),                   // 49: kiapi.board.commands.SetActiveLayer
	(*BoardEditorAppearanceSettings)(nil),    // 50: kiapi.board.commands.BoardEditorAppearanceSettings
	(*GetBoardEditorAppearanceSettings)(nil), // 51: kiapi.board.commands.GetBoardEditorAppearanceSettings
	(*SetBoardEditorAppearanceSettings)(nil), // 52: kiapi.board.commands.SetBoardEditorAppearanceSettings
	(*InteractiveMoveItems)(nil),             // 53: kiapi.board.commands.InteractiveMoveItems
	nil,                                      // 54: kiapi.board.commands.NetClassForNetsResponse.ClassesEntry
	(*types.DocumentSpecifier)(nil),          // 55: kiapi.common.types.DocumentSpecifier
	(*board.BoardStackup)(nil),               // 56: kiapi.board.BoardStackup
	(types1.BoardLayer)(0),                   // 57: kiapi.board.types.BoardLayer
	(*board.GraphicsDefaults)(nil),           // 58: kiapi.board.GraphicsDefaults
	(*board.BoardDesignRules)(nil),           // 59: kiapi.board.BoardDesignRules
	(*board.CustomRule)(nil),                 // 60: kiapi.board.CustomRule
	(*types.Vector2)(nil),                    // 61: kiapi.common.types.Vector2
	(*types1.Net)(nil),                       // 62: kiapi.board.types.Net
	(*types.ItemHeader)(nil),                 // 63: kiapi.common.types.ItemHeader
	(types.KiCadObjectType)(0),               // 64: kiapi.common.types.KiCadObjectType
	(*types.KIID)(nil),                       // 65: kiapi.common.types.KIID
	(*types.PolygonWithHoles)(nil),           // 66: kiapi.common.types.PolygonWithHoles
	(*project.NetClass)(nil),                 // 67: kiapi.common.project.NetClass
}
var file_board_board_commands_proto_depIdxs = []int32{
	55, // 0: kiapi.board.commands.GetBoardStackup.board:type_name -> kiapi.common.types.DocumentSpecifier
	56, // 1: kiapi.board.commands.BoardStackupResponse.stackup:type_name -> kiapi.board.BoardStackup
	55, // 2: kiapi.board.commands.UpdateBoardStackup.board:type_name -> kiapi.common.types.DocumentSpecifier
	56, // 3: kiapi.board.commands.UpdateBoardStackup.stackup:type_name -> kiapi.board.BoardStackup
	55, // 4: kiapi.board.commands.GetBoardEnabledLayers.board:type_name -> kiapi.common.types.DocumentSpecifier
	57, // 5: kiapi.board.commands.BoardEnabledLayersResponse.layers:type_name -> kiapi.board.types.BoardLayer
	55, // 6: kiapi.board.commands.SetBoardEnabledLayers.board:type_name -> kiapi.common.types.DocumentSpecifier
	57, // 7: kiapi.board.commands.SetBoardEnabledLayers.layers:type_name -> kiapi.board.types.BoardLayer
	55, // 8: kiapi.board.commands.GetGraphicsDefaults.board:type_name -> kiapi.common.types.DocumentSpecifier
	58, // 9: kiapi.board.commands.GraphicsDefaultsResponse.defaults:type_name -> kiapi.board.GraphicsDefaults
	55, // 10: kiapi.board.commands.GetBoardDesignRules.board:type_name -> kiapi.common.types.DocumentSpecifier
	55, // 11: kiapi.board.commands.SetBoardDesignRules.board:type_name -> kiapi.common.types.DocumentSpecifier
	59, // 12: kiapi.board.commands.SetBoardDesignRules.rules:type_name -> kiapi.board.BoardDesignRules
	59, // 13: kiapi.board.commands.BoardDesignRulesResponse.rules:type_name -> kiapi.board.BoardDesignRules
	0,  // 14: kiapi.board.commands.BoardDesignRulesResponse.custom_rules_status:type_name -> kiapi.board.commands.CustomRulesStatus
	55, // 15: kiapi.board.commands.GetCustomDesignRules.board:type_name -> kiapi.common.types.DocumentSpecifier
	55, // 16: kiapi.board.commands.SetCustomDesignRules.board:type_name -> kiapi.common.types.DocumentSpecifier
	60, // 17: kiapi.board.commands.SetCustomDesignRules.rules:type_name -> kiapi.board.CustomRule
	0,  // 18: kiapi.board.commands.CustomRulesResponse.status:type_name -> kiapi.board.commands.CustomRulesStatus
	60, // 19: kiapi.board.commands.CustomRulesResponse.rules:type_name -> kiapi.board.CustomRule
	55, // 20: kiapi.board.commands.GetBoardOrigin.board:type_name -> kiapi.common.types.DocumentSpecifier
	1,  // 21: kiapi.board.commands.GetBoardOrigin.type:type_name -> kiapi.board.commands.BoardOriginType
	55, // 22: kiapi.board.commands.SetBoardOrigin.board:type_name -> kiapi.common.types.DocumentSpecifier
	1,  // 23: kiapi.board.commands.SetBoardOrigin.type:type_name -> kiapi.board.commands.BoardOriginType
	61, // 24: kiapi.board.commands.SetBoardOrigin.origin:type_name -> kiapi.common.types.Vector2
	55, // 25: kiapi.board.commands.GetBoardLayerName.board:type_name -> kiapi.common.types.DocumentSpecifier
	57, // 26: kiapi.board.commands.GetBoardLayerName.layer:type_name -> kiapi.board.types.BoardLayer
	55, // 27: kiapi.board.commands.GetNets.board:type_name -> kiapi.common.types.DocumentSpecifier
	62, // 28: kiapi.board.commands.NetsResponse.nets:type_name -> kiapi.board.types.Net
	63, // 29: kiapi.board.commands.GetItemsByNet.header:type_name -> kiapi.common.types.ItemHeader
	64, // 30: kiapi.board.commands.GetItemsByNet.types:type_name -> kiapi.common.types.KiCadObjectType
	62, // 31: kiapi.board.commands.GetItemsByNet.nets:type_name -> kiapi.board.types.Net
	63, // 32: kiapi.board.commands.GetItemsByNetClass.header:type_name -> kiapi.common.types.ItemHeader
	64, // 33: kiapi.board.commands.GetItemsByNetClass.types:type_name -> kiapi.common.types.KiCadObjectType
	63, // 34: kiapi.board.commands.GetConnectedItems.header:type_name -> kiapi.common.types.ItemHeader
	65, // 35: kiapi.board.commands.GetConnectedItems.items:type_name -> kiapi.common.types.KIID
	64, // 36: kiapi.board.commands.GetConnectedItems.types:type_name -> kiapi.common.types.KiCadObjectType
	62, // 37: kiapi.board.commands.GetNetClassForNets.net:type_name -> kiapi.board.types.Net
	54, // 38: kiapi.board.commands.NetClassForNetsResponse.classes:type_name -> kiapi.board.commands.NetClassForNetsResponse.ClassesEntry
	55, // 39: kiapi.board.commands.ImportNetlist.board:type_name -> kiapi.common.types.DocumentSpecifier
	2,  // 40: kiapi.board.commands.ImportNetlist.match_mode:type_name -> kiapi.board.commands.NetlistMatchMode
	55, // 41: kiapi.board.commands.RefillZones.board:type_name -> kiapi.common.types.DocumentSpecifier
	65, // 42: kiapi.board.commands.RefillZones.zones:type_name -> kiapi.common.types.KIID
	55, // 43: kiapi.board.commands.GetPadShapeAsPolygon.board:type_name -> kiapi.common.types.DocumentSpecifier
	65, // 44: kiapi.board.commands.GetPadShapeAsPolygon.pads:type_name -> kiapi.common.types.KIID
	57, // 45: kiapi.board.commands.GetPadShapeAsPolygon.layer:type_name -> kiapi.board.types.BoardLayer
	65, // 46: kiapi.board.commands.PadShapeAsPolygonResponse.pads:type_name -> kiapi.common.types.KIID
	66, // 47: kiapi.board.commands.PadShapeAsPolygonResponse.polygons:type_name -> kiapi.common.types.PolygonWithHoles
	55, // 48: kiapi.board.commands.CheckPadstackPresenceOnLayers.board:type_name -> kiapi.common.types.DocumentSpecifier
	65, // 49: kiapi.board.commands.CheckPadstackPresenceOnLayers.items:type_name -> kiapi.common.types.KIID
	57, // 50: kiapi.board.commands.CheckPadstackPresenceOnLayers.layers:type_name -> kiapi.board.types.BoardLayer
	65, // 51: kiapi.board.commands.PadstackPresenceEntry.item:type_name -> kiapi.common.types.KIID
	57, // 52: kiapi.board.commands.PadstackPresenceEntry.layer:type_name -> kiapi.board.types.BoardLayer
	3,  // 53: kiapi.board.commands.PadstackPresenceEntry.presence:type_name -> kiapi.board.commands.PadstackPresence
	40, // 54: kiapi.board.commands.PadstackPresenceResponse.entries:type_name -> kiapi.board.commands.PadstackPresenceEntry
	55, // 55: kiapi.board.commands.InjectDrcError.board:type_name -> kiapi.common.types.DocumentSpecifier
	4,  // 56: kiapi.board.commands.InjectDrcError.severity:type_name -> kiapi.board.commands.DrcSeverity
	61, // 57: kiapi.board.commands.InjectDrcError.position:type_name -> kiapi.common.types.Vector2
	65, // 58: kiapi.board.commands.InjectDrcError.items:type_name -> kiapi.common.types.KIID
	65, // 59: kiapi.board.commands.InjectDrcErrorResponse.marker:type_name -> kiapi.common.types.KIID
	55, // 60: kiapi.board.commands.GetVisibleLayers.board:type_name -> kiapi.common.types.DocumentSpecifier
	57, // 61: kiapi.board.commands.BoardLayerResponse.layer:type_name -> kiapi.board.types.BoardLayer
	57, // 62: kiapi.board.commands.BoardLayers.layers:type_name -> kiapi.board.types.BoardLayer
	55, // 63: kiapi.board.commands.SetVisibleLayers.board:type_name -> kiapi.common.types.DocumentSpecifier
	57, // 64: kiapi.board.commands.SetVisibleLayers.layers:type_name -> kiapi.board.types.BoardLayer
	55, // 65: kiapi.board.commands.GetActiveLayer.board:type_name -> kiapi.common.types.DocumentSpecifier
	55, // 66: kiapi.board.commands.SetActiveLayer.board:type_name -> kiapi.common.types.DocumentSpecifier
	57, // 67: kiapi.board.commands.SetActiveLayer.layer:type_name -> kiapi.board.types.BoardLayer
	5,  // 68: kiapi.board.commands.BoardEditorAppearanceSettings.inactive_layer_display:type_name -> kiapi.board.commands.InactiveLayerDisplayMode
	6,  // 69: kiapi.board.commands.BoardEditorAppearanceSettings.net_color_display:type_name -> kiapi.board.commands.NetColorDisplayMode
	7,  // 70: kiapi.board.commands.BoardEditorAppearanceSettings.board_flip:type_name -> kiapi.board.commands.BoardFlipMode
	8,  // 71: kiapi.board.commands.BoardEditorAppearanceSettings.ratsnest_display:type_name -> kiapi.board.commands.RatsnestDisplayMode
	50, // 72: kiapi.board.commands.SetBoardEditorAppearanceSettings.settings:type_name -> kiapi.board.commands.BoardEditorAppearanceSettings
	55, // 73: kiapi.board.commands.InteractiveMoveItems.board:type_name -> kiapi.common.types.DocumentSpecifier
	65, // 74: kiapi.board.commands.InteractiveMoveItems.items:type_name -> kiapi.common.types.KIID
	67, // 75: kiapi.board.commands.NetClassForNetsResponse.ClassesEntry.value:type_name -> kiapi.common.project.NetClass
