...
import (
	...
	types "kicadai/internal/kiapi/gen/common/types"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
)
...
type PadSimElectricalType int32

const (
	PadSimElectricalType_PSET_NONE   PadSimElectricalType = 0
	PadSimElectricalType_PSET_SOURCE PadSimElectricalType = 1
	PadSimElectricalType_PSET_SINK   PadSimElectricalType = 2
)

// Enum value maps for PadSimElectricalType.
var (
	PadSimElectricalType_name = map[int32]string{
		0: "PSET_NONE",
		1: "PSET_SOURCE",
		2: "PSET_SINK",
	}
	PadSimElectricalType_value = map[string]int32{
		"PSET_NONE":   0,
		"PSET_SOURCE": 1,
		"PSET_SINK":   2,
	}
...
func (x PadSimElectricalType) Enum() *PadSimElectricalType {
	p := new(PadSimElectricalType)
	*p = x
	return p
}

func (x PadSimElectricalType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PadSimElectricalType) Descriptor() protoreflect.EnumDescriptor {
	return file_board_board_types_proto_enumTypes[17].Descriptor()
}

func (PadSimElectricalType) Type() protoreflect.EnumType {
	return &file_board_board_types_proto_enumTypes[17]
}

func (x PadSimElectricalType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PadSimElectricalType.Descriptor instead.
func (PadSimElectricalType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ZoneFillMode_ZFM_COPPER_THIEVING ZoneFillMode = 3
)
...
type ThievingPattern int32

const (
	ThievingPattern_TP_UNKNOWN    ThievingPattern = 0
	ThievingPattern_TP_DOTS       ThievingPattern = 1
	ThievingPattern_TP_SQUARES    ThievingPattern = 2
	ThievingPattern_TP_CROSSHATCH ThievingPattern = 3
)

// Enum value maps for ThievingPattern.
var (
	ThievingPattern_name = map[int32]string{
		0: "TP_UNKNOWN",
		1: "TP_DOTS",
		2: "TP_SQUARES",
		3: "TP_CROSSHATCH",
	}
	ThievingPattern_value = map[string]int32{
		"TP_UNKNOWN":    0,
		"TP_DOTS":       1,
		"TP_SQUARES":    2,
		"TP_CROSSHATCH": 3,
...
func (x ThievingPattern) Enum() *ThievingPattern {
	p := new(ThievingPattern)
	*p = x
	return p
}

func (x ThievingPattern) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ThievingPattern) Descriptor() protoreflect.EnumDescriptor {
	return file_board_board_types_proto_enumTypes[25].Descriptor()
}

func (ThievingPattern) Type() protoreflect.EnumType {
	return &file_board_board_types_proto_enumTypes[25]
}

func (x ThievingPattern) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ThievingPattern.Descriptor instead.
func (ThievingPattern) EnumDescriptor() ([]byte, []int) {
...
func (DimensionUnit) Descriptor() protoreflect.EnumDescriptor {
	return file_board_board_types_proto_enumTypes[33].Descriptor()
}

func (DimensionUnit) Type() protoreflect.EnumType {
	return &file_board_board_types_proto_enumTypes[33]
}
...
func (FootprintMountingStyle) Descriptor() protoreflect.EnumDescriptor {
	return file_board_board_types_proto_enumTypes[34].Descriptor()
}

func (FootprintMountingStyle) Type() protoreflect.EnumType {
	return &file_board_board_types_proto_enumTypes[34]
}
...
type Barcode struct {
	...
	Position        *types.Vector2         `protobuf:"bytes,5,opt,name=position,proto3" json:"position,omitempty"`
	Orientation     *types.Angle           `protobuf:"bytes,6,opt,name=orientation,proto3" json:"orientation,omitempty"`
	Layer           BoardLayer             `protobuf:"varint,7,opt,name=layer,proto3,enum=kiapi.board.types.BoardLayer" json:"layer,omitempty"`
	Width           *types.Distance        `protobuf:"bytes,8,opt,name=width,proto3" json:"width,omitempty"`
	Height          *types.Distance        `protobuf:"bytes,9,opt,name=height,proto3" json:"height,omitempty"`
	ShowText        bool                   `protobuf:"varint,10,opt,name=show_text,json=showText,proto3" json:"show_text,omitempty"`
	TextHeight      *types.Distance        `protobuf:"bytes,11,opt,name=text_height,json=textHeight,proto3" json:"text_height,omitempty"`
	Knockout        bool                   `protobuf:"varint,12,opt,name=knockout,proto3" json:"knockout,omitempty"`
	KnockoutMargin  *types.Vector2         `protobuf:"bytes,13,opt,name=knockout_margin,json=knockoutMargin,proto3" json:"knockout_margin,omitempty"`
	Locked          types.LockedState      `protobuf:"varint,14,opt,name=locked,proto3,enum=kiapi.common.types.LockedState" json:"locked,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Barcode) GetId() *types.KIID {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Barcode) GetPosition() *types.Vector2 {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *Barcode) GetOrientation() *types.Angle {
	if x != nil {
...
func (x *Barcode) GetWidth() *types.Distance {
	if x != nil {
		return x.Width
	}
	return nil
...
func (x *Barcode) GetHeight() *types.Distance {
	if x != nil {
		return x.Height
	}
	return nil
...
func (x *Barcode) GetTextHeight() *types.Distance {
	if x != nil {
		return x.TextHeight
	}
	return nil
...
func (x *Barcode) GetKnockoutMargin() *types.Vector2 {
	if x != nil {
...
func (x *Barcode) GetLocked() types.LockedState {
	if x != nil {
		return x.Locked
	}
	return types.LockedState(0)
...
type SymbolPinInfo struct {
	...
	Type types.ElectricalPinType `protobuf:"varint,2,opt,name=type,proto3,enum=kiapi.common.types.ElectricalPinType" json:"type,omitempty"`
...
func (x *SymbolPinInfo) GetType() types.ElectricalPinType {
	if x != nil {
		return x.Type
	}
	return types.ElectricalPinType(0)
}
...
type Pad struct {
	...
	// Since: 9.0.4
	PadToDieLength *types.Distance `protobuf:"bytes,9,opt,name=pad_to_die_length,json=padToDieLength,proto3" json:"pad_to_die_length,omitempty"`
	...
	// Since: 10.0.0
	PadToDieDelay *types.Time `protobuf:"bytes,11,opt,name=pad_to_die_delay,json=padToDieDelay,proto3" json:"pad_to_die_delay,omitempty"`
	// Since: 10.0.5
	SimElectricalType PadSimElectricalType `protobuf:"varint,12,opt,name=sim_electrical_type,json=simElectricalType,proto3,enum=kiapi.board.types.PadSimElectricalType" json:"sim_electrical_type,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Pad) GetPadToDieLength() *types.Distance {
	if x != nil {
...
func (x *Pad) GetPadToDieDelay() *types.Time {
	if x != nil {
...
func (x *Pad) GetSimElectricalType() PadSimElectricalType {
	if x != nil {
		return x.SimElectricalType
	}
	return PadSimElectricalType_PSET_NONE
}
...
type ThievingFillSettings struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Pattern       ThievingPattern        `protobuf:"varint,1,opt,name=pattern,proto3,enum=kiapi.board.types.ThievingPattern" json:"pattern,omitempty"`
	ElementSize   *types.Distance        `protobuf:"bytes,2,opt,name=element_size,json=elementSize,proto3" json:"element_size,omitempty"`
	Gap           *types.Distance        `protobuf:"bytes,3,opt,name=gap,proto3" json:"gap,omitempty"`
	LineWidth     *types.Distance        `protobuf:"bytes,4,opt,name=line_width,json=lineWidth,proto3" json:"line_width,omitempty"`
	Stagger       bool                   `protobuf:"varint,5,opt,name=stagger,proto3" json:"stagger,omitempty"`
	Orientation   *types.Angle           `protobuf:"bytes,6,opt,name=orientation,proto3" json:"orientation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ThievingFillSettings) Reset() {
	*x = ThievingFillSettings{}
	mi := &file_board_board_types_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ThievingFillSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ThievingFillSettings) ProtoMessage() {}

func (x *ThievingFillSettings) ProtoReflect() protoreflect.Message {
	mi := &file_board_board_types_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ThievingFillSettings.ProtoReflect.Descriptor instead.
func (*ThievingFillSettings) Descriptor() ([]byte, []int) {
	return file_board_board_types_proto_rawDescGZIP(), []int{22}
}

func (x *ThievingFillSettings) GetPattern() ThievingPattern {
	if x != nil {
		return x.Pattern
	}
	return ThievingPattern_TP_UNKNOWN
}

func (x *ThievingFillSettings) GetElementSize() *types.Distance {
	if x != nil {
...
func (x *ThievingFillSettings) GetGap() *types.Distance {
	if x != nil {
		return x.Gap
	}
	return nil
...
func (x *ThievingFillSettings) GetLineWidth() *types.Distance {
	if x != nil {
		return x.LineWidth
	}
	return nil
...
func (x *ThievingFillSettings) GetStagger() bool {
	if x != nil {
		return x.Stagger
	}
	return false
...
func (x *ThievingFillSettings) GetOrientation() *types.Angle {
	if x != nil {
		return x.Orientation
	}
	return nil
...
type CopperZoneSettings struct {
	...
	ThievingSettings *ThievingFillSettings   `protobuf:"bytes,10,opt,name=thieving_settings,json=thievingSettings,proto3" json:"thieving_settings,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CopperZoneSettings) GetThievingSettings() *ThievingFillSettings {
	if x != nil {
		return x.ThievingSettings
	}
	return nil
}
...
type ReferenceImage struct {
	...
	TransformOriginOffset *types.Vector2         `protobuf:"bytes,4,opt,name=transform_origin_offset,json=transformOriginOffset,proto3" json:"transform_origin_offset,omitempty"`
	ImageScale            *types.Ratio           `protobuf:"bytes,5,opt,name=image_scale,json=imageScale,proto3" json:"image_scale,omitempty"`
	ImageData             []byte                 `protobuf:"bytes,6,opt,name=image_data,json=imageData,proto3" json:"image_data,omitempty"`
	Locked                types.LockedState      `protobuf:"varint,7,opt,name=locked,proto3,enum=kiapi.common.types.LockedState" json:"locked,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ReferenceImage) GetId() *types.KIID {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ReferenceImage) GetPosition() *types.Vector2 {
	if x != nil {
		return x.Position
	}
	return nil
...
func (x *ReferenceImage) GetTransformOriginOffset() *types.Vector2 {
	if x != nil {
...
func (x *ReferenceImage) GetImageScale() *types.Ratio {
	if x != nil {
		return x.ImageScale
	}
	return nil
...
func (x *ReferenceImage) GetLocked() types.LockedState {
	if x != nil {
		return x.Locked
	}
	return types.LockedState(0)
...
type Group struct {
	...
	Id            *types.KIID            `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Items         []*types.KIID          `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Group) GetItems() []*types.KIID {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *FootprintInstance) Reset() {
	*x = FootprintInstance{}
	mi := &file_board_board_types_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FootprintInstance) Descriptor() ([]byte, []int) {
	return file_board_board_types_proto_rawDescGZIP(), []int{47}
}
...
const file_board_board_types_proto_rawDesc = "" +
	...
	"\n" +
	"no_connect\x18\x03 \x01(\bR\tnoConnect\"\xcd\x05\n" +
	"\x03Pad\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.kiapi.common.types.KIIDR\x02id\x127\n" +
	...
	"\x10pad_to_die_delay\x18\v \x01(\v2\x18.kiapi.common.types.TimeR\rpadToDieDelay\x12W\n" +
	"\x13sim_electrical_type\x18\f \x01(\x0e2'.kiapi.board.types.PadSimElectricalTypeR\x11simElectricalType\"\xf7\x02\n" +
	...
	"borderMode\"\xd9\x02\n" +
	"\x14ThievingFillSettings\x12<\n" +
	"\apattern\x18\x01 \x01(\x0e2\".kiapi.board.types.ThievingPatternR\apattern\x12?\n" +
	"\felement_size\x18\x02 \x01(\v2\x1c.kiapi.common.types.DistanceR\velementSize\x12.\n" +
	"\x03gap\x18\x03 \x01(\v2\x1c.kiapi.common.types.DistanceR\x03gap\x12;\n" +
	"\n" +
	"line_width\x18\x04 \x01(\v2\x1c.kiapi.common.types.DistanceR\tlineWidth\x12\x18\n" +
	"\astagger\x18\x05 \x01(\bR\astagger\x12;\n" +
	"\vorientation\x18\x06 \x01(\v2\x19.kiapi.common.types.AngleR\vorientation\"G\n" +
	"\x10TeardropSettings\x123\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1f.kiapi.board.types.TeardropTypeR\x04type\"\x99\x05\n" +
	...
	"\bteardrop\x18\t \x01(\v2#.kiapi.board.types.TeardropSettingsR\bteardrop\x12T\n" +
	"\x11thieving_settings\x18\n" +
	" \x01(\v2'.kiapi.board.types.ThievingFillSettingsR\x10thievingSettings\"\x8d\x03\n" +
	...
	"\aPT_NPTH\x10\x04*E\n" +
	"\x14PadSimElectricalType\x12\r\n" +
	"\tPSET_NONE\x10\x00\x12\x0f\n" +
	"\vPSET_SOURCE\x10\x01\x12\r\n" +
	"\tPSET_SINK\x10\x02*Y\n" +
	...
	"\vZFM_HATCHED\x10\x02\x12\x17\n" +
	"\x13ZFM_COPPER_THIEVING\x10\x03*n\n" +
	...
	"\x19ZHFBM_USE_HATCH_THICKNESS\x10\x02*Q\n" +
	"\x0fThievingPattern\x12\x0e\n" +
	"\n" +
	"TP_UNKNOWN\x10\x00\x12\v\n" +
	"\aTP_DOTS\x10\x01\x12\x0e\n" +
	"\n" +
	"TP_SQUARES\x10\x02\x12\x11\n" +
	"\rTP_CROSSHATCH\x10\x03*\x81\x01\n" +
...
var file_board_board_types_proto_enumTypes = make([]protoimpl.EnumInfo, 35)
var file_board_board_types_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_board_board_types_proto_goTypes = []any{
	...
	(PadSimElectricalType)(0),             // 17: kiapi.board.types.PadSimElectricalType
	(CustomPadShapeZoneFillStrategy)(0),   // 18: kiapi.board.types.CustomPadShapeZoneFillStrategy
	(ZoneType)(0),                         // 19: kiapi.board.types.ZoneType
	(TeardropType)(0),                     // 20: kiapi.board.types.TeardropType
	(IslandRemovalMode)(0),                // 21: kiapi.board.types.IslandRemovalMode
	(ZoneFillMode)(0),                     // 22: kiapi.board.types.ZoneFillMode
	(ZoneHatchSmoothing)(0),               // 23: kiapi.board.types.ZoneHatchSmoothing
	(ZoneHatchFillBorderMode)(0),          // 24: kiapi.board.types.ZoneHatchFillBorderMode
	(ThievingPattern)(0),                  // 25: kiapi.board.types.ThievingPattern
	(PlacementRuleSourceType)(0),          // 26: kiapi.board.types.PlacementRuleSourceType
	(ZoneBorderStyle)(0),                  // 27: kiapi.board.types.ZoneBorderStyle
	(DimensionTextBorderStyle)(0),         // 28: kiapi.board.types.DimensionTextBorderStyle
	(DimensionUnitFormat)(0),              // 29: kiapi.board.types.DimensionUnitFormat
	(DimensionArrowDirection)(0),          // 30: kiapi.board.types.DimensionArrowDirection
	(DimensionPrecision)(0),               // 31: kiapi.board.types.DimensionPrecision
	(DimensionTextPosition)(0),            // 32: kiapi.board.types.DimensionTextPosition
	(DimensionUnit)(0),                    // 33: kiapi.board.types.DimensionUnit
	(FootprintMountingStyle)(0),           // 34: kiapi.board.types.FootprintMountingStyle
	(*NetCode)(nil),                       // 35: kiapi.board.types.NetCode
	(*Net)(nil),                           // 36: kiapi.board.types.Net
	(*Track)(nil),                         // 37: kiapi.board.types.Track
	(*Arc)(nil),                           // 38: kiapi.board.types.Arc
	(*ChamferedRectCorners)(nil),          // 39: kiapi.board.types.ChamferedRectCorners
	(*ZoneConnectionSettings)(nil),        // 40: kiapi.board.types.ZoneConnectionSettings
	(*SolderMaskOverrides)(nil),           // 41: kiapi.board.types.SolderMaskOverrides
	(*SolderPasteOverrides)(nil),          // 42: kiapi.board.types.SolderPasteOverrides
	(*PadStackLayer)(nil),                 // 43: kiapi.board.types.PadStackLayer
	(*PadStackOuterLayer)(nil),            // 44: kiapi.board.types.PadStackOuterLayer
	(*DrillProperties)(nil),               // 45: kiapi.board.types.DrillProperties
	(*PostMachiningProperties)(nil),       // 46: kiapi.board.types.PostMachiningProperties
	(*PadStack)(nil),                      // 47: kiapi.board.types.PadStack
	(*Via)(nil),                           // 48: kiapi.board.types.Via
	(*BoardGraphicShape)(nil),             // 49: kiapi.board.types.BoardGraphicShape
	(*Barcode)(nil),                       // 50: kiapi.board.types.Barcode
	(*BoardText)(nil),                     // 51: kiapi.board.types.BoardText
	(*BoardTextBox)(nil),                  // 52: kiapi.board.types.BoardTextBox
	(*ThermalSpokeSettings)(nil),          // 53: kiapi.board.types.ThermalSpokeSettings
	(*SymbolPinInfo)(nil),                 // 54: kiapi.board.types.SymbolPinInfo
	(*Pad)(nil),                           // 55: kiapi.board.types.Pad
	(*HatchFillSettings)(nil),             // 56: kiapi.board.types.HatchFillSettings
	(*ThievingFillSettings)(nil),          // 57: kiapi.board.types.ThievingFillSettings
	(*TeardropSettings)(nil),              // 58: kiapi.board.types.TeardropSettings
	(*CopperZoneSettings)(nil),            // 59: kiapi.board.types.CopperZoneSettings
	(*RuleAreaSettings)(nil),              // 60: kiapi.board.types.RuleAreaSettings
	(*ZoneBorderSettings)(nil),            // 61: kiapi.board.types.ZoneBorderSettings
	(*ZoneFilledPolygons)(nil),            // 62: kiapi.board.types.ZoneFilledPolygons
	(*ZoneLayerProperties)(nil),           // 63: kiapi.board.types.ZoneLayerProperties
	(*Zone)(nil),                          // 64: kiapi.board.types.Zone
	(*AlignedDimensionAttributes)(nil),    // 65: kiapi.board.types.AlignedDimensionAttributes
	(*OrthogonalDimensionAttributes)(nil), // 66: kiapi.board.types.OrthogonalDimensionAttributes
	(*RadialDimensionAttributes)(nil),     // 67: kiapi.board.types.RadialDimensionAttributes
	(*LeaderDimensionAttributes)(nil),     // 68: kiapi.board.types.LeaderDimensionAttributes
	(*CenterDimensionAttributes)(nil),     // 69: kiapi.board.types.CenterDimensionAttributes
	(*Dimension)(nil),                     // 70: kiapi.board.types.Dimension
	(*ReferenceImage)(nil),                // 71: kiapi.board.types.ReferenceImage
	(*Group)(nil),                         // 72: kiapi.board.types.Group
	(*FieldId)(nil),                       // 73: kiapi.board.types.FieldId
	(*Field)(nil),                         // 74: kiapi.board.types.Field
	(*FootprintAttributes)(nil),           // 75: kiapi.board.types.FootprintAttributes
	(*NetTieDefinition)(nil),              // 76: kiapi.board.types.NetTieDefinition
	(*FootprintDesignRuleOverrides)(nil),  // 77: kiapi.board.types.FootprintDesignRuleOverrides
	(*Footprint3DModel)(nil),              // 78: kiapi.board.types.Footprint3DModel
	(*JumperGroup)(nil),                   // 79: kiapi.board.types.JumperGroup
	(*JumperSettings)(nil),                // 80: kiapi.board.types.JumperSettings
	(*Footprint)(nil),                     // 81: kiapi.board.types.Footprint
	(*FootprintInstance)(nil),             // 82: kiapi.board.types.FootprintInstance
	(*types.KIID)(nil),                    // 83: kiapi.common.types.KIID
	(*types.Vector2)(nil),                 // 84: kiapi.common.types.Vector2
	(*types.Distance)(nil),                // 85: kiapi.common.types.Distance
	(types.LockedState)(0),                // 86: kiapi.common.types.LockedState
	(*types.Ratio)(nil),                   // 87: kiapi.common.types.Ratio
	(*types.Angle)(nil),                   // 88: kiapi.common.types.Angle
	(*types.GraphicShape)(nil),            // 89: kiapi.common.types.GraphicShape
	(*types.Text)(nil),                    // 90: kiapi.common.types.Text
	(*types.TextBox)(nil),                 // 91: kiapi.common.types.TextBox
	(types.ElectricalPinType)(0),          // 92: kiapi.common.types.ElectricalPinType
	(*types.Time)(nil),                    // 93: kiapi.common.types.Time
	(*types.PolySet)(nil),                 // 94: kiapi.common.types.PolySet
	(types.AxisAlignment)(0),              // 95: kiapi.common.types.AxisAlignment
	(*types.Vector3D)(nil),                // 96: kiapi.common.types.Vector3D
	(*types.LibraryIdentifier)(nil),       // 97: kiapi.common.types.LibraryIdentifier
	(*anypb.Any)(nil),                     // 98: google.protobuf.Any
	(*types.SheetPath)(nil),               // 99: kiapi.common.types.SheetPath
}
var file_board_board_types_proto_depIdxs = []int32{
	35,  // 0: kiapi.board.types.Net.code:type_name -> kiapi.board.types.NetCode
	83,  // 1: kiapi.board.types.Track.id:type_name -> kiapi.common.types.KIID
	84,  // 2: kiapi.board.types.Track.start:type_name -> kiapi.common.types.Vector2
	84,  // 3: kiapi.board.types.Track.end:type_name -> kiapi.common.types.Vector2
	85,  // 4: kiapi.board.types.Track.width:type_name -> kiapi.common.types.Distance
	86,  // 5: kiapi.board.types.Track.locked:type_name -> kiapi.common.types.LockedState
	0,   // 6: kiapi.board.types.Track.layer:type_name -> kiapi.board.types.BoardLayer
	36,  // 7: kiapi.board.types.Track.net:type_name -> kiapi.board.types.Net
	83,  // 8: kiapi.board.types.Arc.id:type_name -> kiapi.common.types.KIID
	84,  // 9: kiapi.board.types.Arc.start:type_name -> kiapi.common.types.Vector2
	84,  // 10: kiapi.board.types.Arc.mid:type_name -> kiapi.common.types.Vector2
	84,  // 11: kiapi.board.types.Arc.end:type_name -> kiapi.common.types.Vector2
	85,  // 12: kiapi.board.types.Arc.width:type_name -> kiapi.common.types.Distance
	86,  // 13: kiapi.board.types.Arc.locked:type_name -> kiapi.common.types.LockedState
	0,   // 14: kiapi.board.types.Arc.layer:type_name -> kiapi.board.types.BoardLayer
	36,  // 15: kiapi.board.types.Arc.net:type_name -> kiapi.board.types.Net
	4,   // 16: kiapi.board.types.ZoneConnectionSettings.zone_connection:type_name -> kiapi.board.types.ZoneConnectionStyle
	53,  // 17: kiapi.board.types.ZoneConnectionSettings.thermal_spokes:type_name -> kiapi.board.types.ThermalSpokeSettings
	85,  // 18: kiapi.board.types.SolderMaskOverrides.solder_mask_margin:type_name -> kiapi.common.types.Distance
	85,  // 19: kiapi.board.types.SolderPasteOverrides.solder_paste_margin:type_name -> kiapi.common.types.Distance
	87,  // 20: kiapi.board.types.SolderPasteOverrides.solder_paste_margin_ratio:type_name -> kiapi.common.types.Ratio
	...
	84,  // 23: kiapi.board.types.PadStackLayer.size:type_name -> kiapi.common.types.Vector2
	39,  // 24: kiapi.board.types.PadStackLayer.chamfered_corners:type_name -> kiapi.board.types.ChamferedRectCorners
	49,  // 25: kiapi.board.types.PadStackLayer.custom_shapes:type_name -> kiapi.board.types.BoardGraphicShape
	3,   // 26: kiapi.board.types.PadStackLayer.custom_anchor_shape:type_name -> kiapi.board.types.PadStackShape
	40,  // 27: kiapi.board.types.PadStackLayer.zone_settings:type_name -> kiapi.board.types.ZoneConnectionSettings
	84,  // 28: kiapi.board.types.PadStackLayer.trapezoid_delta:type_name -> kiapi.common.types.Vector2
	84,  // 29: kiapi.board.types.PadStackLayer.offset:type_name -> kiapi.common.types.Vector2
	...
	41,  // 32: kiapi.board.types.PadStackOuterLayer.solder_mask_settings:type_name -> kiapi.board.types.SolderMaskOverrides
	42,  // 33: kiapi.board.types.PadStackOuterLayer.solder_paste_settings:type_name -> kiapi.board.types.SolderPasteOverrides
	...
	84,  // 38: kiapi.board.types.DrillProperties.diameter:type_name -> kiapi.common.types.Vector2
	...
	45,  // 45: kiapi.board.types.PadStack.drill:type_name -> kiapi.board.types.DrillProperties
	2,   // 46: kiapi.board.types.PadStack.unconnected_layer_removal:type_name -> kiapi.board.types.UnconnectedLayerRemoval
	43,  // 47: kiapi.board.types.PadStack.copper_layers:type_name -> kiapi.board.types.PadStackLayer
	88,  // 48: kiapi.board.types.PadStack.angle:type_name -> kiapi.common.types.Angle
	44,  // 49: kiapi.board.types.PadStack.front_outer_layers:type_name -> kiapi.board.types.PadStackOuterLayer
	44,  // 50: kiapi.board.types.PadStack.back_outer_layers:type_name -> kiapi.board.types.PadStackOuterLayer
	40,  // 51: kiapi.board.types.PadStack.zone_settings:type_name -> kiapi.board.types.ZoneConnectionSettings
	45,  // 52: kiapi.board.types.PadStack.secondary_drill:type_name -> kiapi.board.types.DrillProperties
	45,  // 53: kiapi.board.types.PadStack.tertiary_drill:type_name -> kiapi.board.types.DrillProperties
	46,  // 54: kiapi.board.types.PadStack.front_post_machining:type_name -> kiapi.board.types.PostMachiningProperties
	46,  // 55: kiapi.board.types.PadStack.back_post_machining:type_name -> kiapi.board.types.PostMachiningProperties
	83,  // 56: kiapi.board.types.Via.id:type_name -> kiapi.common.types.KIID
	84,  // 57: kiapi.board.types.Via.position:type_name -> kiapi.common.types.Vector2
	47,  // 58: kiapi.board.types.Via.pad_stack:type_name -> kiapi.board.types.PadStack
	86,  // 59: kiapi.board.types.Via.locked:type_name -> kiapi.common.types.LockedState
	36,  // 60: kiapi.board.types.Via.net:type_name -> kiapi.board.types.Net
	13,  // 61: kiapi.board.types.Via.type:type_name -> kiapi.board.types.ViaType
	89,  // 62: kiapi.board.types.BoardGraphicShape.shape:type_name -> kiapi.common.types.GraphicShape
	0,   // 63: kiapi.board.types.BoardGraphicShape.layer:type_name -> kiapi.board.types.BoardLayer
	36,  // 64: kiapi.board.types.BoardGraphicShape.net:type_name -> kiapi.board.types.Net
	83,  // 65: kiapi.board.types.BoardGraphicShape.id:type_name -> kiapi.common.types.KIID
	86,  // 66: kiapi.board.types.BoardGraphicShape.locked:type_name -> kiapi.common.types.LockedState
	83,  // 67: kiapi.board.types.Barcode.id:type_name -> kiapi.common.types.KIID
	...
	84,  // 70: kiapi.board.types.Barcode.position:type_name -> kiapi.common.types.Vector2
	88,  // 71: kiapi.board.types.Barcode.orientation:type_name -> kiapi.common.types.Angle
	0,   // 72: kiapi.board.types.Barcode.layer:type_name -> kiapi.board.types.BoardLayer
	85,  // 73: kiapi.board.types.Barcode.width:type_name -> kiapi.common.types.Distance
	85,  // 74: kiapi.board.types.Barcode.height:type_name -> kiapi.common.types.Distance
	85,  // 75: kiapi.board.types.Barcode.text_height:type_name -> kiapi.common.types.Distance
	84,  // 76: kiapi.board.types.Barcode.knockout_margin:type_name -> kiapi.common.types.Vector2
	86,  // 77: kiapi.board.types.Barcode.locked:type_name -> kiapi.common.types.LockedState
	83,  // 78: kiapi.board.types.BoardText.id:type_name -> kiapi.common.types.KIID
	90,  // 79: kiapi.board.types.BoardText.text:type_name -> kiapi.common.types.Text
	0,   // 80: kiapi.board.types.BoardText.layer:type_name -> kiapi.board.types.BoardLayer
	86,  // 81: kiapi.board.types.BoardText.locked:type_name -> kiapi.common.types.LockedState
	83,  // 82: kiapi.board.types.BoardTextBox.id:type_name -> kiapi.common.types.KIID
	91,  // 83: kiapi.board.types.BoardTextBox.textbox:type_name -> kiapi.common.types.TextBox
	0,   // 84: kiapi.board.types.BoardTextBox.layer:type_name -> kiapi.board.types.BoardLayer
	86,  // 85: kiapi.board.types.BoardTextBox.locked:type_name -> kiapi.common.types.LockedState
	85,  // 86: kiapi.board.types.ThermalSpokeSettings.width:type_name -> kiapi.common.types.Distance
	88,  // 87: kiapi.board.types.ThermalSpokeSettings.angle:type_name -> kiapi.common.types.Angle
	85,  // 88: kiapi.board.types.ThermalSpokeSettings.gap:type_name -> kiapi.common.types.Distance
	92,  // 89: kiapi.board.types.SymbolPinInfo.type:type_name -> kiapi.common.types.ElectricalPinType
	83,  // 90: kiapi.board.types.Pad.id:type_name -> kiapi.common.types.KIID
	86,  // 91: kiapi.board.types.Pad.locked:type_name -> kiapi.common.types.LockedState
	36,  // 92: kiapi.board.types.Pad.net:type_name -> kiapi.board.types.Net
	16,  // 93: kiapi.board.types.Pad.type:type_name -> kiapi.board.types.PadType
	47,  // 94: kiapi.board.types.Pad.pad_stack:type_name -> kiapi.board.types.PadStack
	84,  // 95: kiapi.board.types.Pad.position:type_name -> kiapi.common.types.Vector2
	85,  // 96: kiapi.board.types.Pad.copper_clearance_override:type_name -> kiapi.common.types.Distance
	85,  // 97: kiapi.board.types.Pad.pad_to_die_length:type_name -> kiapi.common.types.Distance
	54,  // 98: kiapi.board.types.Pad.symbol_pin:type_name -> kiapi.board.types.SymbolPinInfo
	93,  // 99: kiapi.board.types.Pad.pad_to_die_delay:type_name -> kiapi.common.types.Time
	17,  // 100: kiapi.board.types.Pad.sim_electrical_type:type_name -> kiapi.board.types.PadSimElectricalType
	85,  // 101: kiapi.board.types.HatchFillSettings.thickness:type_name -> kiapi.common.types.Distance
	85,  // 102: kiapi.board.types.HatchFillSettings.gap:type_name -> kiapi.common.types.Distance
	88,  // 103: kiapi.board.types.HatchFillSettings.orientation:type_name -> kiapi.common.types.Angle
	24,  // 104: kiapi.board.types.HatchFillSettings.border_mode:type_name -> kiapi.board.types.ZoneHatchFillBorderMode
	25,  // 105: kiapi.board.types.ThievingFillSettings.pattern:type_name -> kiapi.board.types.ThievingPattern
	85,  // 106: kiapi.board.types.ThievingFillSettings.element_size:type_name -> kiapi.common.types.Distance
	85,  // 107: kiapi.board.types.ThievingFillSettings.gap:type_name -> kiapi.common.types.Distance
	85,  // 108: kiapi.board.types.ThievingFillSettings.line_width:type_name -> kiapi.common.types.Distance
	88,  // 109: kiapi.board.types.ThievingFillSettings.orientation:type_name -> kiapi.common.types.Angle
	20,  // 110: kiapi.board.types.TeardropSettings.type:type_name -> kiapi.board.types.TeardropType
	40,  // 111: kiapi.board.types.CopperZoneSettings.connection:type_name -> kiapi.board.types.ZoneConnectionSettings
	85,  // 112: kiapi.board.types.CopperZoneSettings.clearance:type_name -> kiapi.common.types.Distance
	85,  // 113: kiapi.board.types.CopperZoneSettings.min_thickness:type_name -> kiapi.common.types.Distance
	21,  // 114: kiapi.board.types.CopperZoneSettings.island_mode:type_name -> kiapi.board.types.IslandRemovalMode
	22,  // 115: kiapi.board.types.CopperZoneSettings.fill_mode:type_name -> kiapi.board.types.ZoneFillMode
	56,  // 116: kiapi.board.types.CopperZoneSettings.hatch_settings:type_name -> kiapi.board.types.HatchFillSettings
	36,  // 117: kiapi.board.types.CopperZoneSettings.net:type_name -> kiapi.board.types.Net
	58,  // 118: kiapi.board.types.CopperZoneSettings.teardrop:type_name -> kiapi.board.types.TeardropSettings
	57,  // 119: kiapi.board.types.CopperZoneSettings.thieving_settings:type_name -> kiapi.board.types.ThievingFillSettings
	26,  // 120: kiapi.board.types.RuleAreaSettings.placement_source_type:type_name -> kiapi.board.types.PlacementRuleSourceType
	27,  // 121: kiapi.board.types.ZoneBorderSettings.style:type_name -> kiapi.board.types.ZoneBorderStyle
	85,  // 122: kiapi.board.types.ZoneBorderSettings.pitch:type_name -> kiapi.common.types.Distance
	0,   // 123: kiapi.board.types.ZoneFilledPolygons.layer:type_name -> kiapi.board.types.BoardLayer
	94,  // 124: kiapi.board.types.ZoneFilledPolygons.shapes:type_name -> kiapi.common.types.PolySet
	0,   // 125: kiapi.board.types.ZoneLayerProperties.layer:type_name -> kiapi.board.types.BoardLayer
	84,  // 126: kiapi.board.types.ZoneLayerProperties.hatching_offset:type_name -> kiapi.common.types.Vector2
	83,  // 127: kiapi.board.types.Zone.id:type_name -> kiapi.common.types.KIID
	19,  // 128: kiapi.board.types.Zone.type:type_name -> kiapi.board.types.ZoneType
	0,   // 129: kiapi.board.types.Zone.layers:type_name -> kiapi.board.types.BoardLayer
	94,  // 130: kiapi.board.types.Zone.outline:type_name -> kiapi.common.types.PolySet
	59,  // 131: kiapi.board.types.Zone.copper_settings:type_name -> kiapi.board.types.CopperZoneSettings
	60,  // 132: kiapi.board.types.Zone.rule_area_settings:type_name -> kiapi.board.types.RuleAreaSettings
	62,  // 133: kiapi.board.types.Zone.filled_polygons:type_name -> kiapi.board.types.ZoneFilledPolygons
	61,  // 134: kiapi.board.types.Zone.border:type_name -> kiapi.board.types.ZoneBorderSettings
	86,  // 135: kiapi.board.types.Zone.locked:type_name -> kiapi.common.types.LockedState
	63,  // 136: kiapi.board.types.Zone.layer_properties:type_name -> kiapi.board.types.ZoneLayerProperties
	84,  // 137: kiapi.board.types.AlignedDimensionAttributes.start:type_name -> kiapi.common.types.Vector2
	84,  // 138: kiapi.board.types.AlignedDimensionAttributes.end:type_name -> kiapi.common.types.Vector2
	85,  // 139: kiapi.board.types.AlignedDimensionAttributes.height:type_name -> kiapi.common.types.Distance
	85,  // 140: kiapi.board.types.AlignedDimensionAttributes.extension_height:type_name -> kiapi.common.types.Distance
	84,  // 141: kiapi.board.types.OrthogonalDimensionAttributes.start:type_name -> kiapi.common.types.Vector2
	84,  // 142: kiapi.board.types.OrthogonalDimensionAttributes.end:type_name -> kiapi.common.types.Vector2
	85,  // 143: kiapi.board.types.OrthogonalDimensionAttributes.height:type_name -> kiapi.common.types.Distance
	85,  // 144: kiapi.board.types.OrthogonalDimensionAttributes.extension_height:type_name -> kiapi.common.types.Distance
	95,  // 145: kiapi.board.types.OrthogonalDimensionAttributes.alignment:type_name -> kiapi.common.types.AxisAlignment
	84,  // 146: kiapi.board.types.RadialDimensionAttributes.center:type_name -> kiapi.common.types.Vector2
	84,  // 147: kiapi.board.types.RadialDimensionAttributes.radius_point:type_name -> kiapi.common.types.Vector2
	85,  // 148: kiapi.board.types.RadialDimensionAttributes.leader_length:type_name -> kiapi.common.types.Distance
	84,  // 149: kiapi.board.types.LeaderDimensionAttributes.start:type_name -> kiapi.common.types.Vector2
	84,  // 150: kiapi.board.types.LeaderDimensionAttributes.end:type_name -> kiapi.common.types.Vector2
	28,  // 151: kiapi.board.types.LeaderDimensionAttributes.border_style:type_name -> kiapi.board.types.DimensionTextBorderStyle
	84,  // 152: kiapi.board.types.CenterDimensionAttributes.center:type_name -> kiapi.common.types.Vector2
	84,  // 153: kiapi.board.types.CenterDimensionAttributes.end:type_name -> kiapi.common.types.Vector2
	83,  // 154: kiapi.board.types.Dimension.id:type_name -> kiapi.common.types.KIID
	86,  // 155: kiapi.board.types.Dimension.locked:type_name -> kiapi.common.types.LockedState
	0,   // 156: kiapi.board.types.Dimension.layer:type_name -> kiapi.board.types.BoardLayer
	90,  // 157: kiapi.board.types.Dimension.text:type_name -> kiapi.common.types.Text
	65,  // 158: kiapi.board.types.Dimension.aligned:type_name -> kiapi.board.types.AlignedDimensionAttributes
	66,  // 159: kiapi.board.types.Dimension.orthogonal:type_name -> kiapi.board.types.OrthogonalDimensionAttributes
	67,  // 160: kiapi.board.types.Dimension.radial:type_name -> kiapi.board.types.RadialDimensionAttributes
	68,  // 161: kiapi.board.types.Dimension.leader:type_name -> kiapi.board.types.LeaderDimensionAttributes
	69,  // 162: kiapi.board.types.Dimension.center:type_name -> kiapi.board.types.CenterDimensionAttributes
	33,  // 163: kiapi.board.types.Dimension.unit:type_name -> kiapi.board.types.DimensionUnit
	29,  // 164: kiapi.board.types.Dimension.unit_format:type_name -> kiapi.board.types.DimensionUnitFormat
	30,  // 165: kiapi.board.types.Dimension.arrow_direction:type_name -> kiapi.board.types.DimensionArrowDirection
	31,  // 166: kiapi.board.types.Dimension.precision:type_name -> kiapi.board.types.DimensionPrecision
	85,  // 167: kiapi.board.types.Dimension.line_thickness:type_name -> kiapi.common.types.Distance
	85,  // 168: kiapi.board.types.Dimension.arrow_length:type_name -> kiapi.common.types.Distance
	85,  // 169: kiapi.board.types.Dimension.extension_offset:type_name -> kiapi.common.types.Distance
	32,  // 170: kiapi.board.types.Dimension.text_position:type_name -> kiapi.board.types.DimensionTextPosition
	83,  // 171: kiapi.board.types.ReferenceImage.id:type_name -> kiapi.common.types.KIID
	0,   // 172: kiapi.board.types.ReferenceImage.layer:type_name -> kiapi.board.types.BoardLayer
	84,  // 173: kiapi.board.types.ReferenceImage.position:type_name -> kiapi.common.types.Vector2
	84,  // 174: kiapi.board.types.ReferenceImage.transform_origin_offset:type_name -> kiapi.common.types.Vector2
	87,  // 175: kiapi.board.types.ReferenceImage.image_scale:type_name -> kiapi.common.types.Ratio
	86,  // 176: kiapi.board.types.ReferenceImage.locked:type_name -> kiapi.common.types.LockedState
	83,  // 177: kiapi.board.types.Group.id:type_name -> kiapi.common.types.KIID
	83,  // 178: kiapi.board.types.Group.items:type_name -> kiapi.common.types.KIID
	73,  // 179: kiapi.board.types.Field.id:type_name -> kiapi.board.types.FieldId
	51,  // 180: kiapi.board.types.Field.text:type_name -> kiapi.board.types.BoardText
	34,  // 181: kiapi.board.types.FootprintAttributes.mounting_style:type_name -> kiapi.board.types.FootprintMountingStyle
	41,  // 182: kiapi.board.types.FootprintDesignRuleOverrides.solder_mask:type_name -> kiapi.board.types.SolderMaskOverrides
	42,  // 183: kiapi.board.types.FootprintDesignRuleOverrides.solder_paste:type_name -> kiapi.board.types.SolderPasteOverrides
	85,  // 184: kiapi.board.types.FootprintDesignRuleOverrides.copper_clearance:type_name -> kiapi.common.types.Distance
	4,   // 185: kiapi.board.types.FootprintDesignRuleOverrides.zone_connection:type_name -> kiapi.board.types.ZoneConnectionStyle
	96,  // 186: kiapi.board.types.Footprint3DModel.scale:type_name -> kiapi.common.types.Vector3D
	96,  // 187: kiapi.board.types.Footprint3DModel.rotation:type_name -> kiapi.common.types.Vector3D
	96,  // 188: kiapi.board.types.Footprint3DModel.offset:type_name -> kiapi.common.types.Vector3D
	79,  // 189: kiapi.board.types.JumperSettings.groups:type_name -> kiapi.board.types.JumperGroup
	97,  // 190: kiapi.board.types.Footprint.id:type_name -> kiapi.common.types.LibraryIdentifier
	84,  // 191: kiapi.board.types.Footprint.anchor:type_name -> kiapi.common.types.Vector2
	75,  // 192: kiapi.board.types.Footprint.attributes:type_name -> kiapi.board.types.FootprintAttributes
	77,  // 193: kiapi.board.types.Footprint.overrides:type_name -> kiapi.board.types.FootprintDesignRuleOverrides
	76,  // 194: kiapi.board.types.Footprint.net_ties:type_name -> kiapi.board.types.NetTieDefinition
	0,   // 195: kiapi.board.types.Footprint.private_layers:type_name -> kiapi.board.types.BoardLayer
	74,  // 196: kiapi.board.types.Footprint.reference_field:type_name -> kiapi.board.types.Field
	74,  // 197: kiapi.board.types.Footprint.value_field:type_name -> kiapi.board.types.Field
	74,  // 198: kiapi.board.types.Footprint.datasheet_field:type_name -> kiapi.board.types.Field
	74,  // 199: kiapi.board.types.Footprint.description_field:type_name -> kiapi.board.types.Field
	98,  // 200: kiapi.board.types.Footprint.items:type_name -> google.protobuf.Any
	80,  // 201: kiapi.board.types.Footprint.jumpers:type_name -> kiapi.board.types.JumperSettings
	83,  // 202: kiapi.board.types.FootprintInstance.id:type_name -> kiapi.common.types.KIID
	84,  // 203: kiapi.board.types.FootprintInstance.position:type_name -> kiapi.common.types.Vector2
	88,  // 204: kiapi.board.types.FootprintInstance.orientation:type_name -> kiapi.common.types.Angle
	0,   // 205: kiapi.board.types.FootprintInstance.layer:type_name -> kiapi.board.types.BoardLayer
	86,  // 206: kiapi.board.types.FootprintInstance.locked:type_name -> kiapi.common.types.LockedState
	81,  // 207: kiapi.board.types.FootprintInstance.definition:type_name -> kiapi.board.types.Footprint
	74,  // 208: kiapi.board.types.FootprintInstance.reference_field:type_name -> kiapi.board.types.Field
	74,  // 209: kiapi.board.types.FootprintInstance.value_field:type_name -> kiapi.board.types.Field
	74,  // 210: kiapi.board.types.FootprintInstance.datasheet_field:type_name -> kiapi.board.types.Field
	74,  // 211: kiapi.board.types.FootprintInstance.description_field:type_name -> kiapi.board.types.Field
	75,  // 212: kiapi.board.types.FootprintInstance.attributes:type_name -> kiapi.board.types.FootprintAttributes
	77,  // 213: kiapi.board.types.FootprintInstance.overrides:type_name -> kiapi.board.types.FootprintDesignRuleOverrides
	99,  // 214: kiapi.board.types.FootprintInstance.symbol_path:type_name -> kiapi.common.types.SheetPath
...
func file_board_board_types_proto_init() {
	...
	file_board_board_types_proto_msgTypes[29].OneofWrappers = []any{
		(*Zone_CopperSettings)(nil),
		(*Zone_RuleAreaSettings)(nil),
	}
	file_board_board_types_proto_msgTypes[35].OneofWrappers = []any{
