// Package capabilitybaselinev9 validates the frozen V9 generation-zero
// discovery evidence envelope without running synthesis or opening held-out
// material.
package capabilitybaselinev9

import "kicadai/internal/capabilityroundsv9"

const (
	CaseEvidenceSchema = "kicadai.closed-loop-open-set-case-evidence.v9"
	ReportSchema       = "kicadai.closed-loop-open-set-discovery-baseline.v9"
	Version            = 9
)
...
type CaseEvidence struct {
	...
	Case                    capabilityroundsv9.Case `json:"case"`
