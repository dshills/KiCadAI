...
func auditBytesV8(manifest ManifestV8, manifestHash string, discovery DiscoveryObligationsV8, heldOut HeldOutObligationCommitmentV8) []byte {
	var output strings.Builder
	output.WriteString("# Closed-Loop Open-Set V8 Corpus Freeze Audit\n\n")
