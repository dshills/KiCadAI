...
func auditBytesV6(manifest Manifest, manifestHash string) []byte {
	var output strings.Builder
	output.WriteString("# Closed-Loop Open-Set V6 Corpus Freeze Audit\n\n")
	...
	roles := sortedKeys(manifest.Counts)
