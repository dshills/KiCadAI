// Package capabilitybaselinepublicationv9 atomically publishes and verifies
// the public V9 generation-zero discovery baseline. It has no held-out or key
// access surface.
package capabilitybaselinepublicationv9

import "kicadai/internal/capabilitybaselinev9"

const (
	ManifestSchema = "kicadai.closed-loop-open-set-baseline-publication.v9"
	Version        = 9
...
type Manifest struct {
	...
	OutcomeCounts []capabilitybaselinev9.OutcomeCount `json:"outcome_counts"`
...
type Request struct {
	...
	Binding         Binding
	Report          capabilitybaselinev9.Report
}
