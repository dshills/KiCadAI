...
func TestClassifyKnownIssueCodes(t *testing.T) {
	tests := []struct {
		...
		{name: "route contact miss", issue: reports.Issue{Code: reports.CodeRouteContactMiss}, want: CategoryUnroutedNet, repairable: true},
		{name: "route contact missing target", issue: reports.Issue{Code: reports.CodeRouteContactMissingTarget}, want: CategoryUnroutedNet, repairable: true},
		{name: "route contact layer mismatch", issue: reports.Issue{Code: reports.CodeRouteContactLayerMismatch}, want: CategoryUnroutedNet, repairable: true},
		{name: "route graph incomplete", issue: reports.Issue{Code: reports.CodeRouteGraphIncomplete}, want: CategoryUnroutedNet, repairable: true},
		{name: "route completion partial", issue: reports.Issue{Code: reports.CodeRouteCompletionPartial}, want: CategoryUnroutedNet, repairable: true},
		{name: "route contact net mismatch", issue: reports.Issue{Code: reports.CodeRouteContactNetMismatch}, want: CategoryInvalidNetAssignment, repairable: true},
		{name: "route contact ambiguous", issue: reports.Issue{Code: reports.CodeRouteContactAmbiguous}, want: CategoryUnsupportedObject, repairable: false},
		{name: "route contact unsupported", issue: reports.Issue{Code: reports.CodeRouteContactUnsupported}, want: CategoryUnsupportedObject, repairable: false},
