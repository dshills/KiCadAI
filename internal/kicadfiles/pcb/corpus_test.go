...
func TestScanCorpusReportsPCBCompatibilityDimensions(t *testing.T) {
  ...
  (component_classes)
	...
	assertCorpusCount(t, report.SupportedObjects, "dimension", 1)
	assertCorpusCount(t, report.PreservationOnly, "teardrops", 1)
	assertCorpusCount(t, report.PreservationOnly, "group", 1)
	assertCorpusCount(t, report.PreservationOnly, "image", 1)
	assertCorpusCount(t, report.PreservationOnly, "table", 1)
	assertCorpusCount(t, report.PreservationOnly, "target", 1)
	assertCorpusCount(t, report.PreservationOnly, "embedded_files", 1)
	assertCorpusCount(t, report.PreservationOnly, "component_classes", 1)
