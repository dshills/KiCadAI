...
var embeddedSymbolTemplates = map[string]embeddedTemplate{
	...
	"regulator_linear:ap2112k-3.3": {
		...
		connectionPinOverride: map[string]kicadfiles.Point{
			...
			"3": {X: kicadfiles.MM(-2.54)},
			"4": {X: kicadfiles.MM(2.54)},
			"5": {X: kicadfiles.MM(2.54), Y: kicadfiles.MM(-2.54)},
		},
		pins: []TemplatePin{
			{Number: "1", Offset: kicadfiles.Point{X: kicadfiles.MM(-2.54), Y: kicadfiles.MM(2.54)}},
			{Number: "2", Offset: kicadfiles.Point{Y: kicadfiles.MM(-2.54)}},
			{Number: "3", Offset: kicadfiles.Point{X: kicadfiles.MM(-2.54)}},
			{Number: "4", Offset: kicadfiles.Point{X: kicadfiles.MM(2.54)}},
			{Number: "5", Offset: kicadfiles.Point{X: kicadfiles.MM(2.54), Y: kicadfiles.MM(2.54)}},
		},
	},
	...
	"sensor_pressure:bmp280": {
		...
		connectionPinOverride: map[string]kicadfiles.Point{
			...
			"3": {X: kicadfiles.MM(-10.16), Y: kicadfiles.MM(2.54)},
			"4": {X: kicadfiles.MM(-10.16), Y: kicadfiles.MM(5.08)},
			"5": {X: kicadfiles.MM(-10.16)},
			"6": {Y: kicadfiles.MM(10.16)},
			"7": {X: kicadfiles.MM(2.54), Y: kicadfiles.MM(-7.62)},
			"8": {X: kicadfiles.MM(2.54), Y: kicadfiles.MM(10.16)},
		},
		pins: []TemplatePin{
			{Number: "1", Offset: kicadfiles.Point{Y: kicadfiles.MM(7.62)}},
			{Number: "2", Offset: kicadfiles.Point{X: kicadfiles.MM(-10.16), Y: kicadfiles.MM(2.54)}},
			{Number: "3", Offset: kicadfiles.Point{X: kicadfiles.MM(-10.16), Y: kicadfiles.MM(-2.54)}},
			{Number: "4", Offset: kicadfiles.Point{X: kicadfiles.MM(-10.16), Y: kicadfiles.MM(-5.08)}},
			{Number: "5", Offset: kicadfiles.Point{X: kicadfiles.MM(-10.16)}},
			{Number: "6", Offset: kicadfiles.Point{Y: kicadfiles.MM(-10.16)}},
			{Number: "7", Offset: kicadfiles.Point{X: kicadfiles.MM(2.54), Y: kicadfiles.MM(7.62)}},
			{Number: "8", Offset: kicadfiles.Point{X: kicadfiles.MM(2.54), Y: kicadfiles.MM(-10.16)}},
		},
	},
}
